import { CreateApplicationBodySchema, ApplicationFilterSchema, GetApplicationsQuerySchema, AssignUnitRequestBodySchema, ApproveApplicationRequestBodySchema } from 'shared';
