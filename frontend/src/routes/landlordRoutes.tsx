...
import LandlordProfileSwitcher from '../pages/landlord/profile/LandlordProfileSwitcher';
...
const landlordRoutes = [
  ...
  <Route key="landlord-profile-v2" path="/landlord/profile" element={<LandlordProfileSwitcher/>} />,
  <Route
