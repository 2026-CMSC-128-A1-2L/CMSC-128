...
import UpdateManager from "../components/LandlordManagerUpdateController";
...
const ViewSpecificManager: FunctionComponent = () => {
  	...
  	return (<>
    		<div className="w-full h-[1024px] relative overflow-y-auto text-left text-num-14 text-darkslategray-100 font-lora">
      			<div className="absolute top-[0px] left-[0px] w-[1440px] h-[1024px] overflow-hidden flex flex-col items-start isolate shrink-0">
					<SideBar/>
				</div>
        				<img className="w-[1440px] h-[1192px] absolute !!m-[0 important] top-[0px] left-[0px] z-[0] shrink-0" alt="" />
              							...
              							<div className="self-stretch flex flex-col items-start py-0 pl-num-32 pr-20">
                								<div className="self-stretch h-16 overflow-hidden shrink-0 flex items-end p-2.5 box-border">
                  									<div className="flex items-center gap-1.5">
                    										<div className="relative font-semibold cursor-pointer" onClick={onManagersTextClick}>Managers</div>
                								...
                								<div className="self-stretch h-[908px] rounded-[17.27px] bg-white border-whitesmoke-200 border-solid border-[1.1px] box-border flex flex-col items-start gap-[13px] text-center text-num-15_11 text-dimgray font-inter">
                  									<div className="self-stretch h-[412px] rounded-[17.27px] flex flex-col items-start gap-[13px]">
                    										...
                    										<div className="self-stretch overflow-hidden flex items-center py-[4.3px] px-[34.5px] gap-[124.1px]">
                      											<img className="w-[215.8px] relative max-h-full object-cover" alt="" src={DefaultAvatar}/>
                  									...
                  									<div className="self-stretch flex flex-col items-start gap-[43.2px] text-[25.9px] text-darkslategray-100">
                        												...
                        												<div className="h-[63.3px] w-[278.4px] relative shrink-0">
                          													<div className="absolute top-[0px] left-[0px] w-[278.4px] flex items-center justify-between gap-5">
                            														...
                            														<div className="w-[216.9px] flex flex-col items-start gap-[8.6px]">
                              															<b className="self-stretch h-[22.7px] relative tracking-[-0.01em] inline-block shrink-0">Ocular Visitation</b>
                              															<div className="flex items-center py-1 px-0 gap-[7.6px] shrink-0 text-num-14">
                                																<b className="relative">Mon - Wed:</b>
                                																<div className="w-[131.7px] relative leading-6 font-medium flex items-center shrink-0">8:00 AM - 5:00 PM</div>
                              															</div>
                            														</div>
                          													</div>
                        												</div>
                        												<div className="h-[63.3px] w-[480.2px] relative shrink-0">
                          													<div className="absolute top-[0px] left-[0px] w-[480.2px] flex items-center justify-between gap-5">
                            														...
                            														<div className="w-[418.7px] flex flex-col items-start gap-[8.6px]">
                              															<b className="self-stretch h-[22.7px] relative tracking-[-0.01em] inline-block shrink-0">General Inquiries</b>
                              															<div className="self-stretch flex items-center py-1 px-0 gap-[16.2px] text-num-14">
                                																<div className="flex items-center gap-[7.6px]">
                                  																	<b className="w-[65.8px] relative flex items-center shrink-0">Mon - Fri:</b>
                                  																	<div className="w-[131.7px] relative leading-6 font-medium flex items-center shrink-0">8:00 AM - 5:00 PM</div>
                                																</div>
                                																<div className="flex items-center">
                                  																	<b className="w-[65.8px] relative flex items-center shrink-0">Sat-Sun:</b>
                                  																	<div className="h-[20.5px] w-[131.7px] relative leading-6 font-medium flex items-center shrink-0">9:00 AM - 3:00 PM</div>
                                																</div>
                              															</div>
                            														</div>
                          													</div>
                    										...
                    										<div className="self-stretch flex flex-col items-start justify-center py-0 px-[34.5px] gap-[16.2px]">
                      											<div className="self-stretch flex items-center gap-[25.9px]">
                        												...
                        												<img className="h-[19.4px] w-[19.4px] relative cursor-pointer" alt="" onClick={openUpdateManager} src={edit}/>
                      											</div>
                      											<div className="flex flex-col items-start gap-[16.2px] text-left text-num-15_11 text-black">
                        												<div className="w-[971.3px] h-[51.8px] relative">
                          													...
                          													<img className="absolute h-[58.3%] w-[3.11%] top-[20.83%] right-[95.56%] bottom-[20.86%] left-[1.33%] max-w-full overflow-hidden max-h-full" alt="" src={check}/>
                          													<div className="absolute h-[56.18%] w-[92.67%] top-[20.83%] left-[5.78%] leading-[25.9px] font-medium flex items-center">Property Management</div>
                        												</div>
                        												<div className="w-[971.3px] h-[51.8px] relative">
                          													<div className="absolute h-full w-full top-[0%] right-[0%] bottom-[0%] left-[0%] rounded-[10.79px] bg-white border-whitesmoke-200 border-solid border-[1.1px] box-border" />
                          													<img className="absolute h-[58.3%] w-[3.11%] top-[20.83%] right-[95.56%] bottom-[20.86%] left-[1.33%] max-w-full overflow-hidden max-h-full" alt="" src={check}/>
                        												...
                        												<div className="w-[971.3px] h-[51.8px] relative">
                          													<div className="absolute h-full w-full top-[0%] right-[0%] bottom-[0%] left-[0%] rounded-[10.79px] bg-white border-whitesmoke-200 border-solid border-[1.1px] box-border" />
                          													<img className="absolute h-[58.3%] w-[3.11%] top-[20.83%] right-[95.56%] bottom-[20.86%] left-[1.33%] max-w-full overflow-hidden max-h-full" alt="" src={x}/>
                          													<div className="absolute h-[56.18%] w-[92.67%] top-[20.83%] left-[5.78%] leading-[25.9px] font-medium flex items-center">Tenants and Occupants Management</div>
                        												</div>
                      											</div>
                    										</div>
                  									</div>
