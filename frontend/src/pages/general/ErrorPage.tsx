...
const ErrorPage: FunctionComponent = () => {
    ...
    return (
        <div className="w-full h-screen bg-darkslategray flex flex-col items-center justify-center p-4 sm:p-8 text-center text-lg font-inter overflow-hidden">
            <img src={errorOwl} className="w-[130px] sm:w-[180px] md:w-[230px] h-auto object-contain mb-4 animate-pulse drop-shadow-[0_0_25px_rgba(203,246,237,0.5)]" alt="Error Owl" />
