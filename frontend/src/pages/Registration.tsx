    ...
    <div className="w-screen font-sans">
      <div className="px-20 pt-4 pb-12">
        ...
        <div className="rounded-3xl border border-whitesmoke px-10 pt-8 pb-10">
          <h1 className="text-2xl font-bold" style={{ color: '#1a5c50' }}>Welcome to Atlas</h1>
          <p className="text-sm font-semibold text-slategray mt-1">Follow 3 simple steps and you're ready to go!</p>
          ...
          <div className="flex gap-20 px-10 items-start relative">
            ...
            {/* Sticky stepper */}
            <div className="flex flex-col sticky top-10 self-start shrink-0" style={{ minWidth: '160px' }}>
              {steps.map((step, i) => (
                <div key={i} className="flex">
                  <div className="flex flex-col items-center mr-3">
                    ...
                    >
                      ...
                      {currentStep > i && (
                        <Icon icon="material-symbols:check-rounded" className="w-4 h-4 text-white" />
                      )}
                    </div>
                    {i < steps.length - 1 && (
                      <div
                  ...
                  <div className="flex items-start pt-1.5 pb-4">
                    <span
                      ...
                      style={{ color: step.active ? '#1a5c50' : currentStep > i ? '#1a5c50' : '#9ca3af' }}
                    >
                      {step.label}
                    </span>
                  </div>
