      ...
      <div className="flex w-full flex-col gap-[32px] pt-[16px]">
        ...
        <section className="flex w-full flex-col gap-[13px] rounded-[17px] border border-[#f0f0f0] bg-white p-[34px]">
          <div className="flex flex-col gap-[4px]">
            <span className="font-['Inter',sans-serif] text-[15px] font-bold text-[#666]">Manager Profile</span>
            <h1 className="font-['Inter',sans-serif] text-[26px] font-bold text-[#2f3136]">{manager.displayName}</h1>
            <span className="font-['Inter',sans-serif] text-[15px] font-bold text-[#096c5b]">{manager.email}</span>
          </div>
          <section
            ...
            <div className="flex flex-col gap-[16px]">
              {[
                ...
                <div key={label} className="flex flex-col gap-[4px]">
                  <span className="font-['Inter',sans-serif] text-[15px] font-bold text-[#666]">{label}</span>
                  <span className="font-['Inter',sans-serif] text-[15px] font-bold text-black">{value}</span>
                </div>
              ))}
            </div>
            <div className="flex flex-col gap-[16px]">
              {[
                ...
                <div key={label} className="flex flex-col gap-[4px]">
                  <span className="font-['Inter',sans-serif] text-[15px] font-bold text-[#666]">{label}</span>
                  <span className={`font-['Inter',sans-serif] text-[15px] font-bold ${teal ? "text-[#096c5b]" : "text-black"}`}>{value}</span>
                </div>
              ))}
            </div>
          </section>
        ...
        {/* Availability */}
          <h2 className="font-['Inter',sans-serif] text-[26px] font-bold text-[#2f3136]">Availability</h2>
          <div className="flex flex-wrap gap-[48px]">
            <div className="flex items-start gap-[12px]">
              <Icon icon="solar:clock-circle-bold-duotone" className="mt-[2px] h-[28px] w-[28px] shrink-0 text-[#096c5b]" aria-hidden="true" />
              <div className="flex flex-col gap-[6px]">
                <span className="font-['Inter',sans-serif] text-[18px] font-bold tracking-[-0.01em] text-[#096c5b]">Ocular Visitation</span>
            ...
            <div className="flex items-start gap-[12px]">
              <Icon icon="solar:chat-round-dots-bold-duotone" className="mt-[2px] h-[28px] w-[28px] shrink-0 text-[#096c5b]" aria-hidden="true" />
              <div className="flex flex-col gap-[6px]">
                <span className="font-['Inter',sans-serif] text-[18px] font-bold tracking-[-0.01em] text-[#096c5b]">General Inquiries</span>
                {manager.availability.inquiries.map((slot) => (
                  <span key={slot.days} className="font-['Inter',sans-serif] text-[14px] text-[#2f3136]">
        ...
        {/* Permissions */}
          ...
          <div className="flex items-center gap-[12px]">
            <h2 className="font-['Inter',sans-serif] text-[26px] font-bold text-[#2f3136]">Permissions</h2>
            <button
            ...
            >
              <Icon icon="solar:pen-bold" className="h-[20px] w-[20px] text-[#096c5b]" aria-hidden="true" />
            </button>
          </div>
          <div className="flex flex-col gap-[12px]">
            {manager.permissions.map((perm) => (
              <div key={perm.label} className="flex w-full items-center gap-[12px] rounded-[11px] border border-[#f0f0f0] bg-white px-[16px] py-[14px]">
                <Icon
                  ...
                  aria-hidden="true"
                />
                <span className="font-['Inter',sans-serif] text-[15px] font-medium text-[#2f3136]">{perm.label}</span>
              </div>
            ))}
          </div>
        </section>
