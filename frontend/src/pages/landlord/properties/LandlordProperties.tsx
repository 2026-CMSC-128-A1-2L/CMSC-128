            ...
            <div className="flex w-full flex-col gap-[32px] pt-[16px]">
                ...
                <section className="flex flex-col gap-[12px]">
                    <div className="flex flex-col gap-[4px]">
                        <span className="font-['Inter',sans-serif] text-[14px] font-bold text-[#666]">Properties</span>
                        <div className="flex items-center justify-between">
                            ...
                            <div className="flex items-center gap-[16px]">
                                <div className="flex items-center gap-[8px]">
                                    <span className="font-['Inter',sans-serif] text-[14px] font-bold text-black">Filter By:</span>
                ...
                <section className="flex flex-col gap-[24px]">
                    ...
                    >
                        ...
                        <div className="flex flex-col items-center">
                            <b className="font-['Inter',sans-serif] text-[16px] text-[#5dc2a8]">Add New Listing</b>
                            <span className="text-[14px] font-medium text-[#666]">Register a building, room, etc.</span>
                        </div>
                    </button>
                </section>
            </div>
