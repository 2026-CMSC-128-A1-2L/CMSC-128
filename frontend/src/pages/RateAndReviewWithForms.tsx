						...
						<div className="self-stretch w-[1128px] flex flex-col items-start shrink-0">
							<div className="self-stretch h-16 overflow-hidden shrink-0 flex items-end p-2.5 box-border gap-2.5">
								<div className="h-6 flex items-center gap-1.5">
									<div className="self-stretch w-[79px] relative font-semibold flex items-center shrink-0 cursor-pointer" onClick={onUserProfileTextClick}>User Profile</div>
									<Icon icon="iconamoon:arrow-right-2" className="h-6 w-6 relative" />

									<div className="self-stretch w-[95px] relative font-semibold flex items-center shrink-0 cursor-pointer" onClick={onUserProfileTextClick}>Current Dorm</div>
								...
								<div className="self-stretch h-[349px] flex flex-col items-start gap-3 shrink-0">
									<div className="w-[1128px] h-[196px] flex items-center justify-center py-num-0 px-[100px] box-border">
										<div className="h-[195px] w-[928px] rounded-xl border-whitesmoke-200 border-solid border-[1px] box-border flex items-center gap-2.5">
											<img className="h-[195px] w-[305px] rounded-tl-xl rounded-tr-none rounded-br-none rounded-bl-xl object-cover" alt="" src={OriginalImage} />
									...
									<div className="self-stretch flex flex-col items-center justify-center py-num-12 px-num-32 gap-[37px]">
										<div className="w-[734px] h-[34px] relative">
											<div className="absolute top-[0px] left-[0px] flex items-center gap-[34px]">
												<div className="h-5 w-[115px] relative flex items-center shrink-0">Quality</div>
												...
												<div className="h-[33.2px] w-[347.6px] relative text-num-14 text-center flex items-center justify-center shrink-0">Rate the overall condition of the building, furniture, and utilities. Does everything work as it should?</div>
											</div>
										</div>
										<div className="w-[728px] h-[34px] relative">
											<div className="absolute top-[0px] left-[0px] flex items-center gap-[34px]">
												<div className="h-[19px] w-[115px] relative flex items-center shrink-0">Comfort</div>
												<div className="flex items-center gap-2.5">
													{[1, 2, 3, 4, 5].map((num) => (
														<button
															key={num}
												...
												<div className="h-[33.2px] w-[347.6px] relative text-num-14 text-center flex items-center justify-center shrink-0">Rate the bedding, room layout, and the overall feel of the 'home away from home' experience.</div>
											</div>
										</div>
										<div className="w-[728px] h-[34px] relative">
											<div className="absolute top-[0px] left-[0px] flex items-center gap-8">
												<div className="h-[23px] w-[115px] relative flex items-center shrink-0">Environment</div>
												<div className="flex items-center gap-2.5">
													{[1, 2, 3, 4, 5].map((num) => (
														<button
															key={num}
												...
												<div className="h-[33.2px] w-[347.6px] relative text-num-14 text-center flex items-center justify-center shrink-0">Rate the atmosphere, and cleanliness of the surroundings. Is it a good place for study and rest?</div>
											</div>
										</div>
									</div>
