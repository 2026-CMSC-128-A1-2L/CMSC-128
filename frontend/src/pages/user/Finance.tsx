      			...
      			<div className="w-full h-[1024px] relative overflow-y-auto flex flex-col items-start isolate gap-2.5 text-left text-[31.85px] text-darkslategray-200 font-buhun-retro-two-free">
        				...
        				<div className="w-[1440px] h-[1192px] overflow-hidden shrink-0 flex flex-col items-start z-[1]">
          					<div className="self-stretch flex-1 overflow-hidden flex flex-col items-start py-num-0 pl-num-0 pr-20">
            						<div className="w-[1440px] flex-1 flex items-start shrink-0">
              							<div className="self-stretch w-[200px] flex items-start">
                								<div className="h-[884px] w-[200px] bg-white border-whitesmoke-200 border-solid border-[1px] box-border hidden flex-col items-center py-num-32 px-num-0 gap-8">
                  									...
                  									<div className="self-stretch h-[760px] flex flex-col items-start gap-8 shrink-0 text-num-12 text-dimgray font-lora">
                    										<div className="self-stretch flex flex-col items-start py-num-0 pl-num-32 pr-num-20">
                      											<div className="self-stretch h-11 rounded-num-100 bg-whitesmoke-200 overflow-hidden shrink-0 flex items-center py-1 px-3 box-border">
                        												<div className="flex-1 overflow-hidden flex items-start py-num-10 px-num-0">
                          													<div className="relative tracking-num-0_02 font-semibold">Search</div>
                        												</div>
                        												<div className="h-7 w-7 rounded-num-100 bg-teal overflow-hidden shrink-0 flex flex-col items-center justify-center">
                          													<img className="w-6 h-6 relative" alt="" />
                        												</div>
                      											</div>
                    										</div>
                    										<div className="self-stretch flex flex-col items-start gap-[132px] text-num-14 text-black font-inter">
                      											<div className="self-stretch flex flex-col items-start gap-3">
                        												...
                        												<div className="w-num-180 flex items-center py-num-0 pl-num-0 pr-num-20 box-border gap-6 cursor-pointer" onClick={onMessagesContainerClick}>
                          													<div className="h-11 w-2 rounded-num-4 bg-white overflow-hidden shrink-0 flex flex-col items-start py-num-10 pl-num-10 pr-num-0 box-border" />
                          													<div className="self-stretch flex-1 rounded-num-12 flex items-center">
                            														<div className="flex-1 flex items-center gap-4">
                              															...
                              															<b className="relative">Messages</b>
                            														</div>
                          													</div>
                        												</div>
                        												<div className="w-num-180 flex items-center py-num-0 pl-num-0 pr-num-20 box-border gap-6 cursor-pointer" onClick={onMessagesContainerClick}>
                          													...
                          													<div className="self-stretch flex-1 rounded-num-12 flex items-center">
                            														<div className="flex-1 flex items-center gap-4">
                              															...
                              															<b className="flex-1 relative">Bookmarks</b>
                            														</div>
                          													</div>
                        												</div>
                        												<div className="w-num-180 flex items-center py-num-0 pl-num-0 pr-num-20 box-border gap-6 cursor-pointer" onClick={onMessagesContainerClick}>
                          													...
                          													<div className="self-stretch flex-1 rounded-num-12 flex items-center">
                            														<div className="flex-1 flex items-center gap-4">
                              															...
                              															<b className="flex-1 relative">My Calendar</b>
                            														</div>
                          													</div>
                        												</div>
                        												<div className="w-num-180 flex items-center py-num-0 pl-num-0 pr-num-20 box-border gap-6 cursor-pointer text-teal" onClick={onFinanceContainerClick}>
                          													<div className="h-11 w-2 rounded-num-4 bg-white overflow-hidden shrink-0 flex flex-col items-start py-num-10 pl-num-10 pr-num-0 box-border" />
                          													<div className="self-stretch flex-1 rounded-num-12 flex items-center">
                            														<div className="flex-1 flex items-center gap-4">
                              															<div className="flex items-center">
                              															...
                              															<b className="flex-1 relative">Finance</b>
                            														</div>
                          													</div>
                        												</div>
                        												<div className="w-num-180 flex items-center py-num-0 pl-num-0 pr-num-20 box-border gap-6 cursor-pointer text-gray" onClick={onMessagesContainerClick}>
                          													<div className="h-11 w-2 rounded-num-4 bg-white overflow-hidden shrink-0 flex flex-col items-start py-num-10 pl-num-10 pr-num-0 box-border" />
                          													<div className="self-stretch flex-1 rounded-num-12 flex items-center">
                            														<div className="flex-1 flex items-center gap-4">
                              															<div className="flex items-center">
                              															...
                              															<b className="flex-1 relative">Settings</b>
                            														</div>
                          													</div>
                        												</div>
                      											</div>
                      											<div className="self-stretch flex flex-col items-start gap-3">
                        												<div className="w-num-180 flex items-center py-num-0 pl-num-0 pr-num-20 box-border gap-6 shrink-0">
                          													<div className="h-11 w-2 rounded-num-4 bg-white overflow-hidden shrink-0 flex flex-col items-start py-num-10 pl-num-10 pr-num-0 box-border" />
                          													<div className="self-stretch flex-1 rounded-num-12 flex items-center">
                            														<div className="flex-1 flex items-center gap-4">
                              															<div className="flex items-center">
                              															...
                              															<b className="flex-1 relative">Dark Mode</b>
                            														</div>
                          													</div>
                        												</div>
                        												<div className="self-stretch flex flex-col items-start py-num-0 px-num-20 shrink-0">
                          													<div className="self-stretch h-0.5 rounded-num-100 bg-whitesmoke-200 overflow-hidden shrink-0 flex items-start pt-num-10 px-num-10 pb-num-0 box-border" />
                        												</div>
                        												<div className="w-[294px] h-[140px] overflow-hidden shrink-0 flex items-start py-num-10 pl-num-32 pr-num-20 box-border">
                          													<div className="flex items-center justify-center gap-2">
                            														<img className="w-11 relative max-h-full object-cover" alt="" />
                            														<div className="h-12 overflow-hidden flex flex-col items-center justify-center gap-1">
                              															<div className="w-[76px] flex items-center">
                                																<b className="relative inline-block max-w-[196px]">Daphne</b>
                              															</div>
                              															<div className="self-stretch flex items-center text-num-8 font-lora">
                                																<div className="flex-1 flex items-center gap-1">
                                  																	<div className="relative tracking-num-0_04 font-semibold text-transparent !bg-clip-text [background:linear-gradient(180deg,_#5dc2a8_27.88%,_#0c8873_84.13%)] [-webkit-background-clip:text] [-webkit-text-fill-color:transparent]">Verified</div>
                      											...
                      											<div className="self-stretch flex-1 flex flex-col items-start gap-8 text-num-14 font-lora">
                        												<div className="self-stretch h-[120px] flex flex-col items-start justify-center py-num-0 px-3 box-border gap-1">
                          													<div className="self-stretch flex items-start justify-between gap-5 text-num-24 font-inter">
                            														...
                            														<div className="w-[200px] rounded-num-12 bg-lightcyan-100 overflow-hidden shrink-0 flex items-center justify-center p-num-10 box-border gap-2.5 cursor-pointer text-center text-num-14 text-teal" ref={buttonContainerRef} onClick={openSubmitReceipt}>
                          													...
                          													<div className="self-stretch flex items-center py-num-0 px-[11px] gap-2">
                            														...
                            														<b className="flex-1 relative">Lot 3, Block 17, Sapphire St, Umali Subd, Los Baños, Philippines, 4030</b>
                          													</div>
                          													<div className="self-stretch flex items-center py-num-0 px-[11px] gap-2">
                            														<Icon icon="mdi-light:map-marker" className="h-5 w-5 relative" />
                        												...
                        												<div className="self-stretch flex items-start gap-3 text-teal font-inter">
                          													<div className="self-stretch w-[300px] rounded-num-16 overflow-hidden shrink-0 flex flex-col items-start py-num-0 px-num-10 box-border gap-2.5">
                            														...
                            														<div className="self-stretch flex-1 flex flex-col items-start gap-1 text-num-18 text-black">
                              															<div className="self-stretch overflow-hidden flex flex-col items-start py-num-10 px-2">
                                																<b className="self-stretch relative tracking-num--0_01">Cost Breakdown</b>
                              															</div>
                              															<div className="self-stretch flex-1 rounded-num-16 border-whitesmoke-200 border-solid border-[1px] overflow-hidden flex flex-col items-start p-num-10 gap-2.5 text-center text-num-14">
                                																...
                                																<div className="self-stretch flex-1 flex flex-col items-start gap-2.5 text-num-12 font-lora">
                                  																	<div className="self-stretch flex items-start justify-center py-2 px-num-0 gap-2.5">
                                    																		<div className="flex-1 relative tracking-num-0_02 font-semibold">Monthly Rent</div>
                                    																		<div className="flex-1 relative tracking-num-0_02 font-semibold text-left">Php</div>
                                  																	</div>
                                  																	<div className="self-stretch flex items-start justify-center py-2 px-num-0 gap-2.5">
                                    																		<div className="flex-1 relative tracking-num-0_02 font-semibold">Electricity</div>
                                    																		<div className="flex-1 relative tracking-num-0_02 font-semibold text-left">Php</div>
                                  																	</div>
                                  																	<div className="self-stretch flex items-start justify-center py-2 px-num-0 gap-2.5">
                                    																		<div className="flex-1 relative tracking-num-0_02 font-semibold">Water</div>
                                    																		<div className="flex-1 relative tracking-num-0_02 font-semibold text-left">Php</div>
                                  																	</div>
                                  																	<div className="self-stretch flex items-start justify-center py-2 px-num-0 gap-2.5">
                                    																		<div className="flex-1 relative tracking-num-0_02 font-semibold">Internet</div>
                                    																		<div className="flex-1 relative tracking-num-0_02 font-semibold text-left">Php</div>
                                  																	</div>
                                  																	<div className="self-stretch flex items-start justify-center py-2 px-num-0 gap-2.5">
                                    																		<div className="flex-1 relative tracking-num-0_02 font-semibold">Others</div>
                                    																		<div className="flex-1 relative tracking-num-0_02 font-semibold text-left">Php</div>
                                  																	</div>
                                																</div>
                            														...
                            														<div className="self-stretch flex items-center gap-2">
                              															...
                              															<div className="flex-1 rounded-num-16 bg-white border-whitesmoke-200 border-solid border-[1px] overflow-hidden flex flex-col items-start p-3 gap-2.5">
                                																...
                                																<div className="flex items-start text-num-24">
                                  																	<div className="relative leading-num-32 font-extrabold text-transparent !bg-clip-text [background:linear-gradient(180deg,_#c29722,_#f6b709)] [-webkit-background-clip:text] [-webkit-text-fill-color:transparent]">PENDING</div>
                                																</div>
                              															</div>
                            														</div>
                            														<div className="self-stretch flex flex-col items-center gap-8 text-center text-num-8 text-black font-lora">
                              															<div className="self-stretch h-[280px] rounded-num-16 bg-white border-whitesmoke-200 border-solid border-[1px] box-border flex flex-col items-center justify-center py-6 px-4 relative isolate gap-2.5">
                                																<div className="w-[572px] !!m-[0 important] absolute top-[70px] left-[16px] flex flex-col items-start gap-2.5 z-[0]">
                                  																	<div className="self-stretch h-40 rounded-[10px] bg-white flex flex-col items-center pt-[26px] pb-[11px] pl-3 pr-[13px] box-border gap-1.5">
                                    																		...
                                    																		<div className="w-[547px] h-[9px] relative">
                                      																			<div className="absolute h-full w-[6.89%] top-[0%] left-[0%] tracking-num-0_04 font-semibold flex items-center justify-center">APR</div>
                                      																			<div className="absolute h-full w-[6.89%] top-[0%] left-[8.46%] tracking-num-0_04 font-semibold flex items-center justify-center">MAY</div>
                                      																			<div className="absolute h-full w-[6.89%] top-[0%] left-[16.93%] tracking-num-0_04 font-semibold flex items-center justify-center">JUN</div>
                                      																			<div className="absolute h-full w-[6.89%] top-[0%] left-[25.39%] tracking-num-0_04 font-semibold flex items-center justify-center">JUL</div>
                                      																			<div className="absolute h-full w-[6.89%] top-[0%] left-[33.86%] tracking-num-0_04 font-semibold flex items-center justify-center">AUG</div>
                                      																			<div className="absolute h-full w-[6.89%] top-[0%] left-[42.32%] tracking-num-0_04 font-semibold flex items-center justify-center">SEP</div>
                                      																			<div className="absolute h-full w-[6.89%] top-[0%] left-[50.78%] tracking-num-0_04 font-semibold flex items-center justify-center">OCT</div>
                                      																			<div className="absolute h-full w-[6.89%] top-[0%] left-[59.25%] tracking-num-0_04 font-semibold flex items-center justify-center">NOV</div>
                                      																			<div className="absolute h-full w-[6.89%] top-[0%] left-[67.71%] tracking-num-0_04 font-semibold flex items-center justify-center">DEC</div>
                                      																			<div className="absolute h-full w-[6.89%] top-[0%] left-[76.18%] tracking-num-0_04 font-semibold flex items-center justify-center">JAN</div>
                                      																			<div className="absolute h-full w-[6.89%] top-[0%] left-[84.64%] tracking-num-0_04 font-semibold flex items-center justify-center">FEB</div>
                                      																			<div className="absolute h-full w-[6.89%] top-[0%] left-[93.1%] tracking-num-0_04 font-semibold flex items-center justify-center">MAR</div>
                                    																		</div>
                                  																	</div>
                                  																	<div className="self-stretch flex items-start justify-between gap-0 text-left text-num-12 text-silver">
                                    																		<div className="w-[122px] flex items-end gap-1">
                                      																			...
                                      																			<div className="h-4 w-[81.9px] relative tracking-num-0_02 font-semibold flex items-center shrink-0">Past Months</div>
                                    																		</div>
                                    																		<div className="flex-1 flex items-end gap-1">
                                      																			<div className="h-[15px] w-[15.4px] relative rounded-num-5 bg-darkslategray-200" />
                                      																			<div className="h-4 w-[98.3px] relative tracking-num-0_02 font-semibold flex items-center shrink-0">Current Month</div>
                                    																		</div>
                                  																	</div>
                                																</div>
                                																<div className="w-[572px] !!m-[0 important] absolute top-[24px] left-[16px] flex items-center justify-center gap-3 z-[1] text-left text-num-18 font-inter">
                                  																	<b className="h-6 flex-1 relative tracking-num--0_01 flex items-center">Monthly Expenses</b>
                                  																	<div className="rounded-num-8 bg-whitesmoke-200 flex flex-col items-start text-center text-[10px] text-white">
                                    																		<div className="self-stretch rounded-num-8 bg-darkslategray-200 flex items-center p-2 gap-1">
                                      																			<div className="self-stretch w-[62px] relative tracking-num-0_04 font-semibold flex items-center justify-center shrink-0">12 Months</div>
                              															...
                              															<div className="self-stretch overflow-hidden flex flex-col items-start p-num-10 gap-2.5 text-left text-num-14 font-inter">
                                																<b className="self-stretch relative text-num-18 tracking-num--0_01">Upcoming Payments</b>
                                																...
                                																<div className="self-stretch rounded-num-8 border-whitesmoke-200 border-solid border-[1px] overflow-hidden flex items-center justify-between py-2 px-num-10 gap-5">
                                  																	<div className="self-stretch flex items-center gap-2.5">
                                    																		...
                                    																		<div className="self-stretch overflow-hidden flex flex-col items-start py-1 pl-num-0 pr-num-10 gap-1">
                                      																			<div className="relative font-semibold shrink-0">April 15, 2026</div>
                                      																			<div className="relative text-num-12 tracking-num-0_02 font-semibold font-lora text-dimgray shrink-0">Php 4500.00</div>
                                    																		</div>
                                  																	</div>
                                  																	<div className="w-20 rounded-num-12 bg-lightcyan-100 overflow-hidden shrink-0 flex items-center justify-center p-num-10 box-border cursor-pointer text-center text-teal" onClick={openPaymentMethods}>
                                																...
                                																<div className="self-stretch rounded-num-8 border-whitesmoke-200 border-solid border-[1px] overflow-hidden flex items-center justify-between py-2 px-num-10 gap-5">
                                  																	<div className="self-stretch flex items-center gap-2.5">
                                    																		<div className="h-5 w-5 rounded-num-4 [background:linear-gradient(180deg,_#c29722,_#f6b709)] overflow-hidden shrink-0 flex flex-col items-start justify-center p-num-10 box-border" />
                                    																		<div className="self-stretch overflow-hidden flex flex-col items-start py-1 pl-num-0 pr-num-10 gap-1">
                                      																			<div className="relative font-semibold shrink-0">May 15, 2026</div>
                                      																			<div className="relative text-num-12 tracking-num-0_02 font-semibold font-lora text-dimgray shrink-0">Php 4500.00</div>
                                    																		</div>
                                  																	</div>
                                  																	<div className="w-20 rounded-num-12 bg-lightcyan-100 overflow-hidden shrink-0 flex items-center justify-center p-num-10 box-border cursor-pointer text-center text-teal" onClick={openPaymentMethods}>
                          													...
                          													<div className="self-stretch w-num-180 rounded-num-16 border-whitesmoke-200 border-solid border-[1px] box-border overflow-hidden shrink-0 flex flex-col items-start py-num-10 px-num-0 gap-2 text-center text-num-24">
                            														<div className="self-stretch rounded-num-16 bg-white overflow-hidden flex flex-col items-start p-3">
                              															<div className="self-stretch relative leading-num-32 font-extrabold">Overview</div>
                            														</div>
                              															...
                              															<div className="self-stretch flex-1 overflow-hidden flex flex-col items-start py-num-0 px-3 gap-2 text-left text-num-12">
                                																<div className="self-stretch rounded-num-8 border-whitesmoke-200 border-solid border-[1px] overflow-hidden flex items-center py-1 px-3">
                                  																	<div className="self-stretch overflow-hidden flex flex-col items-start py-1 pl-num-0 pr-num-10 gap-1">
                                    																		...
                                    																		<div className="relative text-[10px] tracking-num-0_04 font-semibold font-lora text-dimgray">Php 4500.00</div>
                                  																	</div>
                                																</div>
                                																<div className="self-stretch rounded-num-8 border-whitesmoke-200 border-solid border-[1px] overflow-hidden flex items-center py-1 px-3">
                                  																	<div className="self-stretch overflow-hidden flex flex-col items-start py-1 pl-num-0 pr-num-10 gap-1">
