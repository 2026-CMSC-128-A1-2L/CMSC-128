				...
				<div className="w-full max-w-[1048px] mx-auto rounded-[25.44px] rounded-b-none bg-white border-whitesmoke-200 border-solid border-[1px] box-border flex flex-col items-start pt-num-0 px-num-0 pb-[22px] gap-2.5 z-10 shadow-sm">
					<div className="self-stretch flex flex-col sm:flex-row items-start sm:items-center justify-between py-num-10 px-5 sm:px-[30px] gap-3 sm:gap-5 shrink-0 bg-white rounded-t-[25.44px] border-b border-whitesmoke-200">
						<div className="flex flex-col items-start gap-px">
							<b className="relative leading-tight sm:leading-num-32 flex items-center shrink-0 font-inter text-lg sm:text-2xl">Invitation to Current Accommodation</b>
							<div className="self-stretch relative text-[14px] sm:text-[16px] font-medium font-lora flex items-center shrink-0">System</div>
						</div>
						<div className="flex items-center justify-center sm:p-num-10 text-left sm:text-right text-[10px] sm:text-num-12 text-dimgray font-lora">
							<div className="relative tracking-num-0_02 font-semibold">March 30, 2026<br className="hidden sm:block" /> 1:20 am</div>
						</div>
					</div>
					<div className="self-stretch flex flex-col items-center justify-center py-num-10 px-[30px] gap-2.5 shrink-0 text-center text-black">
						<img className="w-[150px] sm:w-[202px] relative max-h-full object-cover my-4 sm:my-6" alt="Owl Logo" src={logoLike} />
						<div className="flex flex-col items-center gap-[7px] w-full">
							<b className="w-full max-w-[564px] relative leading-tight sm:leading-num-32 flex items-center justify-center shrink-0 font-inter text-center text-[16px] sm:text-[20px] md:text-[24px]">Quevin Custodio has invited you to join your current accommodations in Women’s Dormitory</b>
							<div className="flex flex-col items-center justify-end gap-5 text-[16px] sm:text-[18px] w-full">
								<div className="w-full max-w-[604px] shadow-[0px_0px_10px_rgba(0,_0,_0,_0.05)] bg-white border-whitesmoke-200 border-solid border-[1.5px] box-border flex flex-col items-center pt-5 pb-8 sm:pb-10 px-4 sm:px-5 gap-4 sm:gap-5 rounded-lg">
									<b className="w-full max-w-[481.7px] relative tracking-[-0.01em] flex items-center justify-center shrink-0 text-darkslategray font-inter text-lg sm:text-xl text-center">Hi Daphne!</b>
									<div className="flex flex-col items-center gap-2.5 shrink-0 text-num-14 w-full">
										...
										<div className="relative text-[10px] sm:text-num-12 tracking-num-0_02 font-semibold font-lora flex items-center justify-center text-darkslategray mt-2 text-center">This invitation will expire in 7 days.</div>
									</div>
								</div>
								<div className="flex items-center text-center text-[18px] sm:text-[20.87px] text-crimson mt-2 sm:mt-4 w-full justify-center">
									<div className="flex flex-col sm:flex-row items-center gap-3 sm:gap-[23.9px] w-full sm:w-auto">
										...
										<div className="w-full sm:w-[148px] rounded-[17.89px] bg-lightcyan overflow-hidden shrink-0 flex items-center justify-center py-2.5 sm:py-[11.9px] px-[35.8px] box-border cursor-pointer text-teal-200 transition-transform hover:scale-105 active:scale-95 font-inter" onClick={openJoinedDormitoryPopup}>
