...
const FinalizedApplication2b: FunctionComponent = () => {
  	...
  	return (
    		<div className="w-full h-screen relative overflow-y-auto flex flex-col items-start isolate gap-2.5 text-left text-num-14 text-darkslategray-100 font-lora">
      			...
      			<div className="w-[1440px] h-[1512px] overflow-hidden shrink-0 flex flex-col items-start z-[1]">
        				<div className="self-stretch flex-1 overflow-hidden flex flex-col items-start py-num-0 pl-num-0 pr-20">
          					<div className="w-[1440px] flex-1 flex items-center shrink-0">
            						...
            						<div className="h-[1512px] hidden flex-col items-center">
            						...
            						<div className="self-stretch w-[1128px] flex flex-col items-start justify-between gap-0">
              							<div className="w-[1128px] flex flex-col items-start py-num-0 pl-num-32 pr-20 box-border">
                  									...
                  									<div className="self-stretch flex flex-col items-start gap-3 text-darkslategray-100">
                    										<div className="self-stretch flex flex-col items-start gap-6 text-white">
                      											<div className="self-stretch flex flex-col items-center justify-center gap-12">
                        												...
                        												<div className="self-stretch h-8 flex items-center justify-center py-num-0 px-num-32 box-border gap-6 text-[24px] text-darkslategray-100">
                          													...
                          													<div className="relative text-[12px] [text-decoration:underline] font-medium text-transparent !bg-clip-text [background:linear-gradient(180deg,_#c00f0f,_#e44f4f)] [-webkit-background-clip:text] [-webkit-text-fill-color:transparent]">Cancel</div>
                        												</div>
                      											</div>
                      											<div className="self-stretch flex flex-col items-center justify-center text-darkslategray-200 font-poppins">
                        												<div className="w-[784px] h-[92px] relative">
                          													...
                          													<div className="absolute h-[37.93%] w-[13.42%] top-[51.72%] left-[0%] leading-8 font-semibold flex items-center justify-center">Information</div>
                    										...
                    										<div className="self-stretch flex items-center py-num-0 px-num-32 gap-6 text-[24px]">
                      											<div className="flex-1 flex items-center gap-6">
                        												...
                        												<b className="relative text-num-14 text-dimgray">1 out of 3 Documents Approved</b>
                      											</div>
                      											<div className="h-8 w-24 rounded-num-16 bg-aliceblue flex items-center justify-center py-num-0 px-num-12 box-border cursor-pointer text-num-14 text-teal" onClick={onSubmitButtonContainerClick}>
                        												<div className="h-8 w-24 rounded-num-16 bg-lightcyan flex items-center justify-center py-num-0 px-num-12 box-border shrink-0">
                          													<b className="relative">Resubmit</b>
                        												</div>
                      											</div>
                    										</div>
                      											...
                      											<div className="w-[916px] rounded-num-16 bg-white border-whitesmoke border-solid border-[1px] box-border overflow-hidden flex flex-col items-start justify-center py-num-10 px-num-32 gap-2.5">
                        												<div className="self-stretch flex items-center justify-between py-num-0 pl-num-0 pr-6 gap-0">
                          													<div className="flex-1 flex items-center gap-4">
                            														...
                            														<div className="h-8 w-24 rounded-num-16 bg-aliceblue flex items-center justify-center py-num-0 px-num-12 box-border text-center text-slategray">
                              															<b className="relative">Reviewing</b>
                            														</div>
                          													</div>
                        												...
                        												<div className="w-[852px] h-[88px] overflow-hidden shrink-0 flex items-center py-num-12 px-num-0 box-border gap-2.5 text-black">
                          													...
                          													<div className="flex flex-col items-start justify-center gap-2">
                            														...
                            														<div className="relative text-[12px] tracking-num-0_02 font-semibold font-lora text-slategray">Submitted: 02 April 2026</div>
                          													</div>
                        												</div>
                      											</div>
                    										</div>
                      											...
                      											<div className="w-[916px] rounded-num-16 bg-white border-whitesmoke border-solid border-[1px] box-border overflow-hidden flex flex-col items-start justify-center py-num-10 px-num-32 gap-2.5">
                        												<div className="self-stretch flex items-center justify-between py-num-0 pl-num-0 pr-6 gap-0">
                          													<div className="flex-1 flex items-center gap-6">
                            														...
                            														<div className="h-8 w-24 rounded-num-16 bg-aliceblue flex items-center justify-center py-num-0 px-num-12 box-border">
                              															<b className="relative text-transparent !bg-clip-text [background:linear-gradient(180deg,_#c00f0f,_#e44f4f)] [-webkit-background-clip:text] [-webkit-text-fill-color:transparent]">Rejected</b>
                            														</div>
                            														<div className="rounded-num-16 overflow-hidden flex items-center py-num-10 px-4 gap-1 text-[12px] text-teal">
                        												...
                        												<div className="self-stretch flex items-center text-left text-black">
                          													<div className="w-[700px] rounded-num-16 border-dimgray border-dashed border-[1px] box-border overflow-hidden shrink-0 flex items-center py-num-12 px-4">
                            														<div className="h-16 flex items-center gap-6">
                              															<Icon icon = "icons8:upload-2" className="h-16 w-16 relative"  />
                              															<div className="flex flex-col items-start justify-center gap-2">
                                																<b className="relative">Upload the document</b>
                                																<div className="relative text-[12px] tracking-num-0_02 font-semibold font-lora text-slategray">.pdf less than 500KB</div>
                              															</div>
                            														</div>
                          													</div>
                          													<div className="w-[152px] overflow-hidden shrink-0 flex flex-col items-end justify-center py-1 px-2 box-border gap-2.5 text-[12px] font-lora">
                            														<div className="relative tracking-num-0_02 font-semibold text-transparent !bg-clip-text [background:linear-gradient(180deg,_#c00f0f,_#e44f4f)] [-webkit-background-clip:text] [-webkit-text-fill-color:transparent]">* Missing Signature</div>
                            														<div className="relative tracking-num-0_02 font-semibold text-transparent !bg-clip-text [background:linear-gradient(180deg,_#c00f0f,_#e44f4f)] [-webkit-background-clip:text] [-webkit-text-fill-color:transparent]">* Missing Name</div>
                          													</div>
                        												</div>
                        												<div className="w-[115px] h-[15px] flex flex-col items-start justify-center" />
                      											</div>
                    										</div>
                    										<div className="self-stretch flex flex-col items-center justify-center py-num-0 px-num-32 text-left">
                      											<div className="w-[916px] rounded-num-16 bg-white border-whitesmoke border-solid border-[1px] box-border overflow-hidden flex flex-col items-start justify-center py-num-10 px-num-32 gap-2.5">
                        												<div className="self-stretch flex items-center justify-between py-num-0 pl-num-0 pr-6 gap-5">
                          													<div className="w-[492px] flex items-center gap-6">
                            														...
                            														<div className="rounded-num-16 overflow-hidden flex items-center py-num-10 px-4 gap-1 text-center text-[12px] text-teal">
      			...
      			<div className="w-[60px] h-[60px] !!m-[0 important] absolute top-[890px] left-[1281px] rounded-[30px] [background:linear-gradient(183.48deg,_#096c5b,_#16917c)] shrink-0 flex items-start p-[16.2px] box-border cursor-pointer z-[2]" onClick={onArrowUpClick}>
        				<img className="h-[27.7px] w-[27.7px] relative" alt="" src= {Arrow}/>
      			</div>
    		</div>);
};

export default FinalizedApplication2b ;
