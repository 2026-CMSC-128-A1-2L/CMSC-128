...
import FinalizationOfPickingDorm from '../../components/FInalizationOfPickingDorm';
...
const PendingApplication1b: FunctionComponent = () => {
  	...
  	return (<>
      			...
      			<div className="w-[1440px] h-[1312px] overflow-hidden shrink-0 flex flex-col items-start z-[1]">
        				<div className="self-stretch flex-1 overflow-hidden flex flex-col items-start py-num-0 pl-num-0 pr-20">
          					<div className="w-[1440px] flex-1 flex items-center shrink-0">
            						<div className="self-stretch w-num-200 flex items-start" >
                                        <Sidebar />
                                    </div>
            						...
            						<div className="self-stretch flex-1 overflow-hidden flex flex-col items-start justify-between gap-0">
              							<div className="self-stretch h-[1012px] flex flex-col items-start py-num-0 pl-num-32 pr-20 box-border">
                								<div className="self-stretch h-[1012px] flex flex-col items-start">
                  									...
                  									<div className="self-stretch h-[948px] rounded-num-16 bg-white flex flex-col items-start gap-3 text-center text-dimgray font-inter">
                    										<div className="w-[980px] h-[382px] rounded-num-16 flex flex-col items-start gap-3">
                    										...
                    										<div className="self-stretch flex flex-col items-start gap-12 text-white">
                      											<div className="self-stretch flex flex-col items-start">
                        												<div className="self-stretch flex flex-col items-center justify-center">
                          													<div className="w-[520px] h-12 relative">
                            														<div className="absolute h-[99.38%] w-[99.87%] top-[0%] right-[-0.25%] bottom-[0.62%] left-[0.38%] rounded-[99.72px] bg-white flex items-center justify-center p-num-4 box-border gap-1 shrink-0">
                      											...
                      											<div className="self-stretch flex flex-col items-start text-[24px] text-darkslategray-100">
                        												...
                        												<div className="self-stretch rounded-num-16 overflow-hidden flex flex-col items-start py-num-24 px-num-32 text-num-14 text-black">
                          													<div className="self-stretch rounded-num-16 bg-white border-whitesmoke border-solid border-[1px] flex flex-col items-start">
                            														<div className="self-stretch h-12 rounded-t-num-16 rounded-b-none bg-darkslategray-200 border-black border-solid border-[1px] box-border overflow-hidden shrink-0 flex flex-col items-start justify-center py-num-0 px-num-24 text-white">
                              															<div className="self-stretch flex items-center py-num-4 px-num-0 gap-[38px] shrink-0">
                                																<b className="h-16 w-20 relative leading-6 flex items-center justify-center shrink-0">No.</b>
                                																<b className="h-16 w-[220px] relative leading-6 flex items-center justify-center shrink-0">Listing</b>
                                																<b className="h-16 w-[248px] relative leading-6 flex items-center justify-center shrink-0">Address</b>
                                																<b className="h-16 w-[120px] relative leading-6 flex items-center justify-center shrink-0">Status</b>
                                																<b className="h-16 w-num-200 relative leading-6 flex items-center justify-center shrink-0">Actions</b>
                              															</div>
                            														</div>
                            														<div className="self-stretch bg-honeydew overflow-hidden flex flex-col items-start justify-center py-num-0 px-num-24">
                              															<div className="self-stretch flex items-center py-num-4 px-num-0 gap-[38.5px]">
                                																...
                                																<div className="h-16 w-num-200 flex items-center justify-center py-num-4 px-num-0 box-border gap-2 shrink-0 text-[12px] text-crimson">
                                  																	<div className="h-8 w-20 rounded-num-16 bg-gray flex items-center justify-center py-2 px-4 box-border">
                                    																		<div className="relative leading-6 font-medium shrink-0">Cancel</div>
                                  																	</div>
                                  																	<div className="h-8 w-20 rounded-num-16 bg-lightcyan flex items-center justify-center py-2 px-4 box-border cursor-pointer text-teal" onClick={openApplicationFinalizationPick}>
                            														...
                            														<div className="self-stretch rounded-num-16 overflow-hidden flex flex-col items-start justify-center py-num-0 px-num-24">
                              															<div className="self-stretch flex items-center py-num-4 px-num-0 gap-[38.5px]">
                                																...
                                																<div className="h-16 w-num-200 flex items-center justify-center py-num-4 px-num-0 box-border gap-2 shrink-0 text-[12px] text-crimson">
                                  																	...
                                  																	<div className="h-8 w-20 rounded-num-16 bg-aliceblue flex items-center justify-center py-2 px-4 box-border text-slategray">
                                    																		<div className="relative font-semibold">Finalize</div>
                                  																	</div>
                                																</div>
                              															</div>
    		...
    		{isApplicationFinalizationPickOpen && (
      			<PortalPopup
        				...
        				>
        				<FinalizationOfPickingDorm onClose={closeApplicationFinalizationPick}/>
          					</PortalPopup>
          					)}</>);
          					};
          					
          					export default PendingApplication1b ;
