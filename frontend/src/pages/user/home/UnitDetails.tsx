                  ...
                  <div className="self-stretch flex flex-col items-center gap-[28.5px] text-[32px] text-black font-inter">
                    <div className="self-stretch flex items-center gap-[25px]">
                      <div className="flex-1 flex flex-col items-start gap-[25px]">
                        ...
                        <div className="self-stretch flex flex-col items-center">
                          <div className="w-[820.2px] flex items-start justify-between py-0 px-2 box-border gap-5 shrink-0">
                            <div className="flex items-center gap-[5.3px]">
                              ...
                              <b className="h-num-42.8 w-[125.7px] relative text-[24px] leading-8 flex items-center shrink-0 opacity-[0.3]">
                                - 1 pax
                              </b>
                            </div>
                            <div className="flex items-center gap-[17.8px] text-center text-num-10.7 text-teal-200 font-poppins">
                        ...
                        <div className="w-[363.7px] h-[57.1px] relative text-center text-[24px] text-white">
                          <div className="absolute top-0 left-0 shadow-[0px_6.240437030792236px_17.83px_rgba(0,0,0,0.15)] rounded-num-8.91 bg-darkslategray-200 w-[363.7px] h-[57.1px]" />
                      ...
                      <div className="h-[615px] w-full relative bg-white border-whitesmoke-300 border-solid border box-border flex flex-col items-center justify-center py-0 pl-5 pr-2 gap-[25px] text-left text-[14.26px] text-black font-inter">
                        <div className="w-[259.4px] flex items-center justify-between pr-3 shrink-0 text-[21.4px]">
                          ...
                          <div className="h-[19.6px] w-[58.8px] shadow-[0px_0px_2.51px_rgba(0,0,0,0.25)] rounded-[6.27px] bg-whitesmoke-100 flex items-center justify-center py-[5px] px-4 box-border text-center text-[10.04px] text-gray font-lora">
                        ...
                        <div className="self-stretch flex flex-col items-start gap-[21.4px] shrink-0 text-gray font-lora">
                          <div className="flex flex-col items-start gap-[7px] shrink-0">
                            ...
                            <div className="w-num-259.3 flex items-center justify-between gap-[8.9px] text-center text-num-10.7 text-black">
                              <div className="h-[28.5px] w-[125.2px] shadow-[0px_0px_3.57px_rgba(0,0,0,0.25)] rounded-num-8.91 bg-white flex items-center justify-center pt-1 pb-[5px] pl-[11px] pr-3 box-border">
                                <div className="relative tracking-num-0.02 font-semibold">
                                  1 Pax
                                </div>
                              </div>
                              <div className="h-[28.5px] w-[125.2px] shadow-[0px_0px_3.57px_rgba(0,0,0,0.25)] rounded-num-8.91 bg-white flex items-center justify-center pt-1 px-2.5 pb-[5px] box-border">
                                <div className="relative tracking-num-0.02 font-semibold">
                                  2 Pax
                                </div>
                              </div>
                          ...
                          <div className="flex flex-col items-start gap-[7px] shrink-0">
                            ...
                            <div className="w-num-259.3 h-[28.5px] relative text-num-10.7 text-silver">
                              <div className="absolute h-full w-full top-[0%] right-[0%] bottom-[0%] left-[0%] shadow-[0px_0px_3.57px_rgba(0,0,0,0.25)] rounded-num-8.91 bg-white" />
                              <Icon
                                icon="mdi:chevron-down"
                                className="absolute h-[80.6%] w-[50.13%] top-[7.66%] right-[3.8%] bottom-[35.74%] left-[68.08%] overflow-hidden"
                              />
                              <div className="absolute h-[62.46%] w-[50.02%] top-[18.77%] left-[4.14%] tracking-num-0.02 font-semibold flex items-center">
                          ...
                          <div className="flex flex-col items-start gap-[7px] shrink-0">
                            ...
                            <div className="w-num-259.3 h-[29.4px] relative text-num-10.7 text-silver">
                              <div className="absolute h-full w-full top-[0%] right-[0%] bottom-[0%] left-[0%] shadow-[0px_0px_3.57px_rgba(0,0,0,0.25)] rounded-num-8.91 bg-white" />
                              <div className="absolute h-[60.54%] w-[50.02%] top-[21.23%] left-[4.14%] tracking-num-0.02 font-semibold flex items-center">
                                Choose date
                              </div>
                              <Icon
                                icon="mdi:calendar"
                          ...
                          <div className="flex flex-col items-start gap-[7px] shrink-0 text-[14.3px]">
                            ...
                            <div className="w-num-259.3 h-[57.1px] relative text-num-10.7 text-silver">
                              ...
                              <div className="absolute h-[31.17%] w-[86.54%] top-[10.93%] left-[4.14%] tracking-num-0.02 font-semibold flex items-center">
                                Introduce yourself or ask a question..
                              </div>
                            </div>
                          </div>
                          <div className="w-num-259.3 h-[114.1px] shadow-[0px_0px_3.57px_rgba(0,0,0,0.25)] rounded-num-8.91 bg-whitesmoke-200 flex flex-col items-start py-[15px] pl-[21px] pr-[19px] box-border gap-0.5 shrink-0 text-num-10.7 text-dimgray font-poppins">
                        ...
                        <div className="w-num-259.3 flex flex-col items-center gap-[8.9px] shrink-0 text-white font-poppins">
                    ...
                    <div className="self-stretch flex items-start gap-[30.2px] text-center text-num-14.26 text-darkslategray-200 font-lora">
                      <div className="flex-1 flex flex-col items-start gap-[29.4px]">
                        <div className="self-stretch flex flex-col items-start gap-[10.7px] shrink-0">
                          <div className="self-stretch flex items-center gap-[10.7px]">
                            <div className="h-num-42.8 w-[118.6px] relative">
                              <div className="absolute h-full w-full top-[0%] right-[0%] bottom-[0%] left-[0%] rounded-num-8.91 bg-lightcyan border-teal-200 border-solid border-[0.9px] box-border" />
                              <div className="absolute h-[56.31%] w-[81.2%] top-[20.83%] left-[9.77%] font-medium flex items-center justify-center">
                                2 Slots Left
                              </div>
                            </div>
                            <div className="h-num-42.8 w-[118.6px] relative">
                              <div className="absolute h-full w-full top-[0%] right-[0%] bottom-[0%] left-[0%] rounded-num-8.91 border-teal-200 border-solid border-[0.9px] box-border" />
                              <div className="absolute h-[56.31%] w-[81.2%] top-[20.83%] left-[9.77%] font-medium flex items-center justify-center">
                                Transient
                              </div>
                            </div>
                            ...
                            <div className="h-num-42.8 w-[140.9px] relative">
                              <div className="absolute top-0 left-0 w-[140.9px] h-num-42.8">
                                <div className="absolute h-full w-full top-[0%] right-[0%] bottom-[0%] left-[0%] rounded-num-8.91 border-teal-200 border-solid border-[0.9px] box-border" />
                            ...
                            <div className="h-num-42.8 w-[126.6px] relative">
                              <div className="absolute h-full w-full top-[0%] right-[0%] bottom-[0%] left-[0%] rounded-num-8.91 border-teal-200 border-solid border-[0.9px] box-border" />
                              <div className="absolute h-[56.31%] w-[81.2%] top-[20.83%] left-[9.77%] font-medium flex items-center justify-center">
                                Min. 6 Months
                              </div>
                          ...
                          <div className="self-stretch flex items-center gap-[10.7px]">
                            ...
                            <div className="h-num-42.8 w-[145.3px] relative">
                              <div className="absolute h-full w-full top-[0%] right-[0%] bottom-[0%] left-[0%] rounded-num-8.91 border-teal-200 border-solid border-[0.9px] box-border" />
                      ...
                      <div className="flex flex-col items-start gap-[21.4px] text-black font-inter">
                        <div className="w-num-291.5 h-[285.3px] relative shadow-[0px_0px_3.57px_rgba(0,0,0,0.25)]">
                          <div className="absolute h-full w-full top-[0%] right-[0%] bottom-[0%] left-[0%] rounded-num-8.91 bg-white" />
                          <div className="absolute top-[191.67px] left-0 w-num-291.5 flex flex-col items-start py-0 px-[17.8px] box-border gap-2 text-white font-poppins">
                            <div className="self-stretch h-[32.1px] relative">
                              <div className="absolute h-full w-full top-[0%] right-[0%] bottom-[0%] left-[0%]">
                                <div className="absolute h-full w-full top-[0%] right-[0%] bottom-[0%] left-[0%] shadow-[0px_0px_3.57px_rgba(0,0,0,0.25)] rounded-num-8.91 bg-darkslategray-200" />
                              </div>
                          ...
                          <div className="absolute top-[126.59px] left-0 w-num-291.5 flex items-center justify-center py-0 px-[8.9px] box-border gap-[7.1px] text-[16.05px] text-teal-100">
                            <div className="h-[53.5px] w-[124.8px] relative">
                              <div className="absolute h-full w-full top-[0%] right-[0%] bottom-[0%] left-[0%] filter-[drop-shadow(0px_0px_3.57px_rgba(0,0,0,0.25))] rounded-num-8.91 border-teal-100 border-solid border-[0.9px] box-border" />
                              <div className="absolute top-[8.91px] left-[15.16px] w-[94.5px] flex flex-col items-center">
                                ...
                                <div className="self-stretch h-num-14.7 relative text-num-10.7 tracking-num-0.02 font-semibold font-lora text-darkslategray-100 flex items-center justify-center shrink-0">
                                  Active Units
                                </div>
                              </div>
                            </div>
                          ...
                          <div className="absolute top-[59.73px] left-[0.09px] w-num-291.5 flex items-start py-0 px-[17.8px] box-border gap-[8.9px] text-left font-lora">
                            <img
                              className="h-[53.5px] w-[53.5px] relative shadow-[0px_0px_3.57px_rgba(0,0,0,0.25)] rounded-[50%] object-cover"
                              alt=""
                            />
                            <div className="w-[112.4px] flex flex-col items-start gap-[2.7px]">
                              ...
                              <div className="self-stretch h-[19.6px] relative text-num-10.7 tracking-num-0.02 font-semibold text-darkslategray-100 flex items-center shrink-0">
                                member since 2021
                              </div>
                            </div>
                          </div>
                          <div className="absolute top-[16.94px] left-0 w-num-291.5 flex items-center py-0 px-[17.8px] box-border gap-[11.6px] text-left text-[21.4px]">
                            <Icon
