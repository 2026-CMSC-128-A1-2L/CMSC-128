...
const ContactUs: FunctionComponent = () => {
  ...
  const inputStyle = "w-full bg-transparent border-none outline-none text-num-14 font-medium text-darkslategray-200 placeholder:text-dimgray/60";
  const containerStyle = "flex-1 rounded-num-12 bg-aliceblue border-whitesmoke-200 border-solid border overflow-hidden flex items-start py-num-10 px-3 transition-all duration-300 focus-within:bg-white focus-within:shadow-[0_4px_12px_rgba(0,0,0,0.05)] focus-within:border-teal-100/30";
