                        ...
                        <div className="flex items-start justify-center">
                          ...
                          <div className="self-stretch flex items-center justify-center py-num-0 px-3 text-left text-num-14 text-gray font-inter">
                            <div className="flex-1 relative leading-[25px] font-medium">
                              At ATLAS, we're building more than just an
                              app—we're building a community for UPLB students.
                              Have a suggestion to make our portal better? Or
                              maybe a question about securing your own spot?
                              Speak up! Every message helps us make housing
                              better for everyone in the woods.
                            </div>
                          </div>
                        </div>
                        {/* Right Side: THE FORM */}
