                        ...
                        <div className="self-stretch h-[872px] overflow-y-auto shrink-0 flex flex-col items-start gap-12">
                          ...
                          <div className="self-stretch flex flex-col items-start gap-2.5 shrink-0 text-num-18 text-black">
                              ...
                              <div className="h-40 w-num-360 rounded-num-16 bg-white border-whitesmoke-200 border-solid border box-border flex flex-col items-center justify-center">
                                ...
                                <div className="self-stretch flex items-center py-num-10 px-num-24 mt-[-9px] relative text-num-14 font-lora">
                                  <div className="h-20 w-num-312 relative font-medium inline-block shrink-0">
                                    The ATLAS website and all related digital
                                    services operated by the ATLAS team.
                                  </div>
                                </div>
                              </div>
                              <div className="h-40 w-num-360 rounded-num-16 bg-white border-whitesmoke-200 border-solid border box-border flex flex-col items-center justify-center">
                                ...
                                <div className="self-stretch flex items-center py-num-10 px-num-24 mt-[-9px] relative text-num-14 font-lora">
                                  <div className="h-20 w-num-312 relative font-medium inline-block shrink-0">
                                    Any individual who creates an account or
                                    accesses the platform, including tenants,
                                    students, landlords, and housing managers.
                                  </div>
                                </div>
                              </div>
                            </div>
                            <div className="flex items-start gap-2.5">
                              <div className="h-40 w-num-360 rounded-num-16 bg-white border-whitesmoke-200 border-solid border box-border flex flex-col items-center justify-center">
                                ...
                                <div className="self-stretch flex items-center py-num-10 px-num-24 mt-[-9px] relative text-num-14 font-lora">
                                  <div className="h-20 w-num-312 relative font-medium inline-block shrink-0">
                                    A user who browses listings, applies for
                                    units, and manages their lease through the
                                    platform.
                                  </div>
                                </div>
                              </div>
                              <div className="h-40 w-num-360 rounded-num-16 bg-white border-whitesmoke-200 border-solid border box-border flex flex-col items-center justify-center">
                                ...
                                <div className="self-stretch flex items-center py-num-10 px-num-24 mt-[-9px] relative text-num-14 font-lora">
                                  <div className="h-20 w-num-312 relative font-medium inline-block shrink-0">
                                    A user who lists dormitory units, manages
                                    tenancies, and processes billing through the
                                    platform.
                                  </div>
                                </div>
                              </div>
                            ...
                            <div className="flex items-start gap-2.5">
                              <div className="h-40 w-num-360 rounded-num-16 bg-white border-whitesmoke-200 border-solid border box-border flex flex-col items-center justify-center">
                                ...
                                <div className="self-stretch flex items-center py-num-10 px-num-24 mt-[-9px] relative text-num-14 font-lora">
                                  <div className="h-20 w-num-312 relative font-medium inline-block shrink-0">
                                    A dormitory room or unit posted on the
                                    platform by a landlord or housing manager
                          ...
                          <div className="self-stretch flex flex-col items-start gap-2.5 shrink-0 text-num-14 text-black">
                            ...
                            <div className="self-stretch relative leading-num-24 font-medium">
                              <p className="m-0">
                                To access most features of ATLAS, you must
                                ...
                                credentials and for all activities conducted
                                under your account.
                              </p>
                              <p className="m-0">&nbsp;</p>
                              <ul className="m-0 font-inherit text-[length:inherit] pl-num-19">
                                <li className="mb-0">
                                  To be a tenant user, you must be a UPLB
                                  student.
                                </li>
                                <li className="mb-0">
                                ...
                                <li className="mb-0">
                                  You must not create multiple accounts for the
                                  same person, or create accounts on behalf of
                                  others without authorization.
                                </li>
                                <li className="mb-0">
                                  ATLAS reserves the right to verify your
                                  identity and school enrollment status as part
                                  of tenant verification.
                                </li>
                                <li>
                                  You must notify ATLAS immediately if you
                                ...
                                <div className="h-20 w-num-700 flex items-center justify-center py-num-8 px-num-0 box-border">
                                  <div className="h-num-60 w-num-700 relative inline-block shrink-0">
                                    ...
                                    <span className="font-medium font-lora text-dimgray">
                                      ...
                                      is strictly prohibited. ATLAS is not
                                      responsible for any loss or damage arising
                                      from unauthorized account access due to
                          ...
                          <div className="self-stretch flex flex-col items-start gap-2.5 shrink-0 text-num-14 text-black">
                            ...
                            <div className="self-stretch relative leading-num-24 font-medium">
                              ATLAS grants you a limited, non-exclusive,
                              non-transferable, and revocable license to access
                              and use the platform strictly for its intended
                              purpose: finding and managing dormitory
                              accommodations in the vicinity of the University
                              of the Philippines Los Banos.
                              <br />
                              <br />
                              All content on the platform including the ATLAS
                              name, logo, design, text, graphics, and underlying
                              software is the intellectual property of ATLAS or
                              its licensors and is protected by applicable
                              Philippine and international laws. You may not
                              copy, modify, distribute, sell, or lease any part
                              ...
                              <div className="h-20 w-num-740 rounded-num-16 border-whitesmoke-200 border-solid border-t border-r border-b box-border flex items-start justify-center">
                                <div className="h-20 w-num-700 flex items-center justify-center py-num-8 px-num-0 box-border">
                                  <div className="h-num-60 w-num-700 relative inline-block shrink-0">
                                    ...
                                    <span className="font-medium font-lora text-dimgray">
                                      Browsing listings, submitting
                                      applications, managing your lease,
                                      downloading your own billing statements,
                                      and communicating with landlords through
                          ...
                          <div className="self-stretch flex flex-col items-start gap-2.5 shrink-0">
                            ...
                            <div className="self-stretch relative text-num-14 leading-num-24 font-medium text-black">
                              <p className="m-0">
                                As a tenant using ATLAS, you agree to the
                                following responsibilities:
                              </p>
                              <p className="m-0">&nbsp;</p>
                              <ul className="m-0 font-inherit text-[length:inherit] pl-num-19">
                                <li className="mb-0">
                                  Submit only truthful information in
                                  applications, profiles, and lease transfer
                                  requests. Misrepresentation may result in
                                  account suspension.
                                </li>
                                <li className="mb-0">
                                  Fulfill all obligations under your lease
                                  agreement, including timely payment of rent
                                  and utilities as recorded in the billing
                                  system.
                                </li>
                                <li className="mb-0">
                                  Comply with the house rules established by
                                  your landlord and visible in your unit's
                                  listing.
                                </li>
                                <li className="mb-0">
                                  Report maintenance issues through the proper
                                  channels on the platform and cooperate with
                                  the landlord's resolution process.
                                </li>
                                <li className="mb-0">
                                  Seek landlord approval before initiating a
                                  Pasalo (lease transfer) and complete all
                                  required documents on the platform.
                                </li>
                                <li>
                                  Leave the unit in the condition agreed upon at
                                  move-out and settle all outstanding balances
                                  before departure.
                                </li>
                              </ul>
                            </div>
                          ...
                          <div className="self-stretch flex flex-col items-start gap-2.5 shrink-0 text-num-14 text-black">
                            ...
                            <div className="self-stretch relative leading-num-24 font-medium">
                              <p className="m-0">
                                Landlords and housing managers using ATLAS agree
                                to uphold standards of honesty and fair practice
                                in all interactions with tenants on the
                                platform.
                              </p>
                              <p className="m-0">&nbsp;</p>
                              <ul className="m-0 font-inherit text-[length:inherit] pl-num-19">
                                <li className="mb-0">
                                  ...
                                  information in all unit listings, including
                                  photos, amenities, and pricing.
                                </li>
                                <li className="mb-0">
                                  Process tenant applications and lease transfer
                                  requests promptly and within the timelines
                                  specified on the platform.
                                </li>
                                <li className="mb-0">
                                  Issue billing statements accurately and in a
                                  timely manner. Overcharging or fabricating
                                  utility costs is a violation of these terms.
                                </li>
                                <li className="mb-0">
                                  Maintain units in a habitable and safe
                                  condition consistent with the description in
                                  the listing.
                                </li>
                                <li>
                                  Respect tenant privacy and not use ATLAS's
                                  communication tools for purposes outside of
                              ...
                              <div className="h-20 w-num-740 rounded-num-16 border-whitesmoke-200 border-solid border-t border-r border-b box-border flex items-start justify-center">
                                <div className="h-20 w-num-700 flex items-center justify-center py-num-8 px-num-0 box-border">
                                  <div className="h-num-60 w-num-700 relative inline-block shrink-0">
                                    ...
                                    <span className="font-medium font-lora text-dimgray">
                                      Harassment, discrimination, or retaliatory
                                      actions against tenants using the platform
                                      will result in immediate account
                                      suspension and may be reported to relevant
                                      authorities.
                                    </span>
                                  </div>
                                </div>
                          ...
                          <div className="self-stretch flex flex-col items-start gap-2.5 shrink-0">
                            ...
                            <div className="self-stretch relative text-num-14 leading-num-24 text-black">
                              <p className="m-0 font-medium">
                                ATLAS provides a billing management system that
                                enables landlords to issue statements and
                                tenants to record and track payments. It is
                                important to understand the scope and limits of
                                this system:
                              </p>
                              ...
                              <ul className="m-0 text-[length:inherit] pl-num-19">
                                <li className="mb-0">
                                  ...
                                  <span className="font-medium">
                                    . Rent and utility payments are made between
                                    tenants and landlords through their agreed
                                ...
                                <li className="mb-0">
                                  <span className="font-medium">
                                    Billing records on the platform are for
                                    reference and documentation purposes only.
                                    They do not constitute official receipts
                                    unless issued as such by the landlord.
                                  </span>
                                </li>
                                <li className="mb-0">
                                  <span className="font-medium">
                                    Disputes over payment amounts must be
                                    resolved directly between the tenant and
                                    landlord. ATLAS may provide records to
                                    assist resolution but is not an arbitrator.
                                  </span>
                                </li>
                                <li>
                                  <span className="font-medium">
                                    Downloadable PDF billing statements and
                                    monthly reports are generated by the system
                                    for record-keeping purposes and are not
                            ...
                            <div className="self-stretch relative leading-num-24 text-black">
                              <p className="m-0">
                                <span className="font-medium font-inter">
                                  ATLAS collects and processes personal data in
                              ...
                              <ul className="m-0 text-[length:inherit] pl-num-19">
                                <li className="mb-0">
                                  <span className="font-medium">
                                    ...
                                    provide our services, including identity
                                    verification, profile information, and
                                    platform activity.
                                  </span>
                                </li>
                                <li className="mb-0">
                                  <span className="font-medium">
                                    Your personal data is never sold to third
                                    parties. It may be shared with your landlord
                                    only to the extent necessary for tenancy
                                    management.
                                  </span>
                                </li>
                                <li className="mb-0">
                                  <span className="font-medium">
                                    You have the right to access, correct, and
                                    request deletion of your personal data.
                                    Contact our Data Protection Officer to
                                    exercise these rights.
                                  </span>
                                </li>
                                <li>
                                  <span className="font-medium">
                                    Documents uploaded for verification (IDs,
                                    enrollment certificates, etc.) are stored
                              ...
                              <div className="h-20 w-num-740 rounded-num-16 border-whitesmoke-200 border-solid border-t border-r border-b box-border flex items-start justify-center">
                                <div className="h-20 w-num-700 flex items-center justify-center py-num-8 px-num-0 box-border">
                                  <div className="h-num-60 w-num-700 relative font-medium inline-block shrink-0">
                                    ...
                                    , which forms part of these terms by
                                    reference.
                                  </div>
                                </div>
                              </div>
                          ...
                          <div className="self-stretch flex flex-col items-start gap-2.5 shrink-0">
                            ...
                            <div className="self-stretch relative text-num-14 leading-num-24 font-medium text-black">
                              <p className="m-0">
                                The following actions are strictly prohibited on
                                the ATLAS platform. Violations may result in
                                content removal, account suspension, or legal
                                action:
                              </p>
                              <p className="m-0">&nbsp;</p>
                              <ul className="m-0 font-inherit text-[length:inherit] pl-num-19">
                                <li className="mb-0">
                                  Posting false, misleading, or fraudulent
                                  listings or tenant applications.
                                </li>
                                <li className="mb-0">
                                ...
                                <li className="mb-0">
                                  Uploading falsified documents for
                                  verification, application, or lease transfer
                                  purposes.
                                </li>
                                <li className="mb-0">
                                  Harassing, threatening, or abusing other users
                                  through the platform's communication features.
                                </li>
                                <li className="mb-0">
                                  Attempting to access, scrape, or
                                  reverse-engineer any part of the platform's
                                  systems or data.
                                </li>
                                <li>
                                  Using the platform for any illegal purpose,
                                  including money laundering, fraud, or any
                                  activity prohibited under Philippine law.
                                </li>
                              </ul>
                            </div>
                          </div>
                          <div className="self-stretch flex flex-col items-start gap-2.5 shrink-0 text-num-14 text-black">
                                ...
                                <div className="h-20 w-num-700 flex items-center justify-center py-num-8 px-num-0 box-border">
                                  <div className="h-num-60 w-num-700 relative inline-block shrink-0">
                                    ...
                                    <span className="font-medium font-lora text-dimgray">
                                      ...
                                      <span>
                                        ATLAS is a facilitating platform, not a
                                        party to any tenancy agreement. We do
                                        not own, manage, or operate any of the
                                        listed properties.
                                      </span>
                                    </span>
                                  </div>
                            ...
                            <div className="self-stretch relative leading-num-24 font-medium">
                              ATLAS provides the platform on an "as is" and "as
                              available" basis. We make no warranties, express
                              or implied, about the accuracy, completeness, or
                              reliability of listings, user-submitted content,
                              or information on the platform.
                              <br />
                              <br />
                              To the maximum extent permitted by Philippine law,
                              ATLAS shall not be liable for any indirect,
                              incidental, special, consequential, or punitive
                              damages arising from: your use or inability to use
                              the platform; disputes between tenants and
                              landlords; or the content or actions of other
                              users.
                            </div>
                          </div>
                          <div className="self-stretch flex flex-col items-start gap-2.5 shrink-0">
                            ...
                            <div className="self-stretch relative text-num-14 leading-num-24 font-medium text-black">
                              <p className="m-0">
                                ATLAS reserves the right to suspend or terminate
                                your account at any time, with or without
                                notice, for violations of these terms,
                                fraudulent activity, extended inactivity, or any
                                other reason at our discretion.
                              </p>
                              <p className="m-0">
                                You may also close your account at any time by
                                ...
                                or for legitimate business purposes, as
                                described in our Privacy Policy.
                              </p>
                              <p className="m-0">&nbsp;</p>
                              <ul className="m-0 font-inherit text-[length:inherit] pl-num-19">
                                <li className="mb-0">
                                  Outstanding lease obligations or billing
                                  records will remain accessible for download
                                  for 30 days after account closure.
                                </li>
                                <li>
                                  ATLAS will provide notice of termination where
                                  reasonably practicable, except in cases of
                                  serious or urgent violations.
                                </li>
                              </ul>
                            </div>
                          </div>
                          <div className="self-stretch flex flex-col items-start gap-2.5 shrink-0">
                            ...
                            <div className="self-stretch relative text-num-14 leading-num-24 text-black">
                              ...
                              <span className="font-medium">
                                ...
                                terms or your use of ATLAS shall first be
                                attempted to be resolved through good-faith
                                negotiation. If unresolved, disputes shall be
                                submitted to the appropriate courts of the
                                Philippines with proper jurisdiction.
                                <br />
                                <br />
                                ATLAS reserves the right to update or modify
                                these terms at any time. Continued use of the
                                platform after any changes constitutes your
                                acceptance of the revised terms. We will notify
                                users of material changes via email or
