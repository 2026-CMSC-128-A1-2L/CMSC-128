...
import CurrentDorm from './CurrentDorm';
...
const ProfileSwitcher = () => {
  ...
  return (
    <div className="w-full h-screen relative overflow-y-auto flex flex-col items-start isolate gap-2.5 text-left text-num-14 text-darkslategray-100 font-lora">
      <div className="w-full max-w-[1440px] h-auto overflow-hidden shrink-0 flex flex-col items-start z-[1] mx-auto">
        <div className="self-stretch flex-1 flex items-center">
          <div className="fixed top-0 left-0 h-full w-[200px] hidden md:block z-10">
            <Sidebar />
          </div>

          <div className="self-stretch w-[1240px] flex flex-col items-start justify-between gap-20">
            <div className="self-stretch flex flex-col items-start py-num-0 pr-20">
              ...
              <div className="self-stretch h-16 overflow-hidden shrink-0 flex items-end p-num-10 box-border gap-2.5"  data-scroll-to="searchBarContainer">
                <div className="h-6 flex items-center gap-1.5">
                  <div className="relative font-semibold text-dimgray">User Profile</div>
