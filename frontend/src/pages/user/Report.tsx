...
import FaqArrowIcon from '../../assets/Vector.svg';
import UserIcon from '../../assets/Icon3.svg';
import DormImage from '../../assets/Original Image.png';
...
const Report: FunctionComponent = () => {
  	...
  	return (
    		<div className="w-full h-[1024px] relative overflow-y-auto flex flex-col items-start isolate gap-2.5 text-left text-num-14 text-darkslategray-100 font-lora">
      			{/* <img className="w-[1440px] h-[1192px] absolute !!m-[0 important] top-[0px] left-[0px] shrink-0 z-[0]" alt="" src={} /> */}
      			<div className="w-[1440px] h-[1024px] overflow-hidden shrink-0 flex flex-col items-start z-[1]">
                								...
                								<div className="self-stretch flex flex-col items-start gap-3 shrink-0">
                  									<div className="w-[1128px] h-[196px] flex items-center justify-center py-num-0 px-[100px] box-border">
                    										<div className="h-[195px] w-[928px] rounded-xl border-whitesmoke-200 border-solid border-[1px] box-border flex items-center gap-2.5">
                      											<img className="h-[195px] w-[305px] rounded-tl-xl rounded-tr-none rounded-br-none rounded-bl-xl object-cover" alt="" src={DormImage} />
                          													...
                          													<div className="self-stretch flex flex-col items-start gap-[17px] text-num-14">
                            														<div className="self-stretch flex items-center gap-[21px]">
                              															<div className="h-[45.3px] w-[346.7px] relative">
                                																...
                                																<img className="absolute h-[24.94%] w-[0.72%] top-[36.79%] right-[4.39%] bottom-[38.27%] left-[94.88%] max-w-full overflow-hidden max-h-full object-contain" alt="" src={FaqArrowIcon} />
