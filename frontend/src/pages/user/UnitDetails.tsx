                      ...
                      <div className="h-[615px] w-full relative bg-white border-whitesmoke-300 border-solid border-[1px] box-border flex flex-col items-center justify-center py-0 pl-5 pr-2 gap-[25px] text-left text-[14.26px] text-black font-inter">
                        <div className="w-[259.4px] flex items-center justify-between pr-3 shrink-0 text-[21.4px]">
                          <div className="flex items-center gap-[11px]">
                            ...
                            <b className="h-[16.9px] w-[90.3px] relative leading-[28.53px] flex items-center shrink-0">Apply</b>
                          </div>
                          <div className="h-[19.6px] w-[58.8px] shadow-[0px_0px_2.51px_rgba(0,_0,_0,_0.25)] rounded-[6.27px] bg-whitesmoke-100 flex items-center justify-center py-[5px] px-4 box-border text-center text-[10.04px] text-gray font-lora">
                            <div className="h-[9.8px] w-[26.7px] relative font-medium flex items-center justify-center shrink-0">Reset</div>
                          </div>
                        </div>
                        <div className="self-stretch flex flex-col items-start gap-[21.4px] shrink-0 text-gray font-lora">
                          <div className="flex flex-col items-start gap-[7px] shrink-0">
                            <div className="w-[151.1px] h-[13.4px] relative font-medium flex items-center shrink-0">Rooms Available</div>
                            <div className="w-num-259_3 flex items-center justify-between gap-[8.9px] text-center text-num-10_7 text-black">
                              <div className="h-[28.5px] w-[125.2px] shadow-[0px_0px_3.57px_rgba(0,_0,_0,_0.25)] rounded-num-8_91 bg-white flex items-center justify-center pt-1 pb-[5px] pl-[11px] pr-3 box-border">
                                <div className="relative tracking-num-0_02 font-semibold">1 Pax</div>
                              </div>
                              <div className="h-[28.5px] w-[125.2px] shadow-[0px_0px_3.57px_rgba(0,_0,_0,_0.25)] rounded-num-8_91 bg-white flex items-center justify-center pt-1 px-2.5 pb-[5px] box-border">
                                <div className="relative tracking-num-0_02 font-semibold">2 Pax</div>
                              </div>
                            </div>
                          </div>
                          <div className="flex flex-col items-start gap-[7px] shrink-0">
                            <div className="w-[151.1px] h-[13.4px] relative font-medium flex items-center shrink-0">Lease Duration</div>
                            <div className="w-num-259_3 h-[28.5px] relative text-num-10_7 text-silver">
                              ...
                              <Icon icon="mdi:chevron-down" className="absolute h-[80.6%] w-[50.13%] top-[7.66%] right-[3.8%] bottom-[35.74%] left-[68.08%] overflow-hidden" />
                          ...
                          <div className="flex flex-col items-start gap-[7px] shrink-0">
                            <div className="w-[164.5px] h-[13.4px] relative font-medium flex items-center shrink-0">Preferred Move-in Date</div>
                            <div className="w-num-259_3 h-[29.4px] relative text-num-10_7 text-silver">
                              ...
                              <Icon icon="mdi:calendar" className="absolute h-[80.6%] w-[50.13%] top-[7.66%] right-[3.8%] bottom-[35.74%] left-[68.08%] overflow-hidden" />
                            </div>
                          </div>
                          <div className="flex flex-col items-start gap-[7px] shrink-0 text-[14.3px]">
                            ...
                            <div className="w-num-259_3 h-[57.1px] relative text-num-10_7 text-silver">
                              <div className="absolute h-full w-full top-[0%] right-[0%] bottom-[0%] left-[0%] shadow-[0px_0px_3.57px_rgba(0,_0,_0,_0.25)] rounded-num-8_91 bg-white" />
                              <img className="absolute h-[10.86%] w-[2.08%] top-[79.63%] right-[2.39%] bottom-[9.52%] left-[95.53%] rounded-[0.89px] max-w-full overflow-hidden max-h-full" alt="" />
                          ...
                          <div className="w-num-259_3 h-[114.1px] shadow-[0px_0px_3.57px_rgba(0,_0,_0,_0.25)] rounded-num-8_91 bg-whitesmoke-200 flex flex-col items-start py-[15px] pl-[21px] pr-[19px] box-border gap-0.5 shrink-0 text-num-10_7 text-dimgray font-poppins">
                            <div className="flex items-center gap-[31px]">
                              <div className="h-num-17_8 w-[83.2px] relative flex items-center shrink-0">Monthly Rent</div>
                              <div className="h-num-17_8 w-num-104_6 relative text-right flex items-center justify-end shrink-0">₱1000.00</div>
                            </div>
                            <div className="flex items-center gap-[31px]">
                              <div className="h-num-17_8 w-[83.2px] relative flex items-center shrink-0">Est. Utilities</div>
                              <div className="h-num-17_8 w-num-104_6 relative text-right flex items-center justify-end shrink-0">₱500.00</div>
                            </div>
                            <div className="flex items-center gap-[21px]">
                              <div className="h-num-17_8 w-[93px] relative flex items-center shrink-0">Security Deposit</div>
                              <div className="h-num-17_8 w-num-104_6 relative text-right flex items-center justify-end shrink-0">₱2000.00</div>
                            </div>
                            <div className="w-[220.2px] flex flex-col items-start gap-1.5 text-gray">
                              <img className="w-[219.5px] h-[0.9px] relative rounded-[0.89px] max-h-full" alt="" />
                              <div className="self-stretch flex items-center gap-[11px]">
                                <b className="h-num-17_8 w-num-104_6 relative flex items-center shrink-0">Est. Move-in Cost</b>
                                <b className="h-num-17_8 w-num-104_6 relative flex text-right items-center justify-end shrink-0">₱3500.00</b>
                              </div>
                            </div>
                          </div>
                        </div>
                        <div className="w-num-259_3 flex flex-col items-center gap-[8.9px] shrink-0 text-white font-poppins">
                          ...
                          </div>                          <div className="self-stretch h-[26.7px] relative text-num-10_7 font-lora text-dimgray text-center flex items-center justify-center shrink-0">Landlord will respond within 24–48 hrs.<br />Your info is kept private until approved.</div>
                        </div>
                      </div>                    </div>
                          ...
                          <div className="absolute top-[191.67px] left-[0px] w-num-291_5 flex flex-col items-start py-0 px-[17.8px] box-border gap-2 text-white font-poppins">
                            <div className="self-stretch h-[32.1px] relative">
                              ...
                              <div className="absolute h-[49.84%] w-[51.74%] top-[25%] right-[24.31%] bottom-[25.16%] left-[23.95%]">
                                ...
                                <Icon icon="material-symbols:mail-outline" className="absolute h-[95.38%] w-[13.44%] top-[11.15%] right-[86.56%] bottom-[-0.52%] left-[0%] max-w-full overflow-hidden max-h-full" />
                              </div>
                            </div>
                            <div className="w-[256.7px] h-[32.1px] relative">
                              ...
                              <Icon icon="ic:outline-phone" className="absolute h-[44.55%] w-[5.92%] top-[27.77%] right-[69.77%] bottom-[27.68%] left-[24.31%] max-w-full overflow-hidden max-h-full" />
                            </div>
                          </div>
                        ...
                        <div className="self-stretch flex flex-col items-start gap-[19.6px] text-left text-[21.4px]">
                          <div className="self-stretch flex items-center py-0 px-[8.9px] gap-[39.2px]">
                            ...
                            <div className="h-[28.5px] w-[28.5px] relative flex items-center justify-center">
                              ...
                              <Icon icon="iconamoon:arrow-right-2" className="h-6 w-6 relative z-10" />
                            </div>
                          </div>
