      ...
      <div className="relative -mx-[calc((100vw-100%)/2)] flex w-screen flex-col min-h-screen">
        <div className="flex flex-1">
          ...
          <div className="flex-1 bg-white px-10 py-8">
            <h1 className="font-['Outfit'] text-[48px] font-bold text-black">Analytics</h1>
            ...
            <div className="mt-8 rounded-xl bg-white p-8 shadow-[0px_0px_20px_0px_rgba(0,0,0,0.25)]">
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-8">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <span className="font-['Outfit'] text-[18px] text-black">Students</span>
                  </div>
              ...
              <div className="mt-9 flex">
                ...
                <div className="flex flex-1 flex-col">
                  <div className="relative w-full rounded-lg border border-dashed border-[#e0e0e0] bg-[#fafafa]" style={{ height: CHART_HEIGHT }}>
                    {isLoading ? (
