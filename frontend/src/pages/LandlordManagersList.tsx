...
import AddManager from "../components/LandlordManagerAddController.tsx";
import ReportManager from "../components/LandlordManagerReportController.tsx";
...
const Managers: FunctionComponent = () => {
  	...
  	return (<>
    		<div className="w-full h-[1024px] relative overflow-y-auto flex flex-col items-start isolate gap-2.5 text-left text-num-14 text-dimgray font-inter">
                  									...
                  									<div className="w-[980px] h-[948px] flex flex-col items-center gap-8">
                    										<div className="self-stretch flex flex-col items-start gap-3">
                      											<div className="self-stretch flex flex-col items-start gap-[5px]">
                        												<b className="self-stretch h-6 relative flex items-center shrink-0">View All Managers</b>
                        												<div className="self-stretch flex items-center text-[24px] text-black">
                          													<b className="h-6 flex-1 relative leading-8 flex items-center">Property Manager List</b>
                        												</div>
                      											</div>
                    										...
                    										<div className="self-stretch h-[639px] overflow-y-auto shrink-0 flex flex-col items-start p-10 box-border gap-12 text-num-18 text-teal">
                      											<div className="w-[940px] flex flex-col items-start py-0 pl-num-10 pr-0 box-border gap-2.5 shrink-0">
                        												<div className="self-stretch flex items-start gap-2.5">
                          													...
                          													<Icon icon='mdi-light:plus' className="h-6 w-6 relative cursor-pointer" onClick={openAddManager} />
                        												</div>
                        												<div className="flex items-start gap-56 text-black">
                          													<div className="w-[350px] flex flex-col items-start justify-center cursor-pointer" onClick={onTenantContainerClick}>
                            														<div className="w-[331px] h-[100px] overflow-hidden shrink-0 flex items-center justify-center py-num-10 px-num-16 box-border gap-2.5">
                              															<div className="flex items-center gap-2.5 shrink-0">
                                																<img className="h-[77.2px] w-[81.9px] relative object-cover" alt="" src={DefaultAvatar}/>
                                																<div className="h-num-78 w-[212px] flex flex-col items-center justify-between py-num-8 px-1 box-border gap-0">
                                  																	<b className="self-stretch h-[37.6px] relative tracking-num--0_01 flex items-center shrink-0">Daphne Dayne</b>
                                  																	<b className="self-stretch h-[29.7px] relative text-num-14 flex text-dimgray items-center shrink-0">dcanape@up.edu.ph</b>
                                																</div>
                              															</div>
                              															<img id='hi' className="h-num-7 w-5 relative object-cover cursor-pointer shrink-0" alt="" onClick={openReportManager} src={dots}/>
                            														</div>
                          													</div>
                          													<div className="w-[350px] flex flex-col items-start justify-center">
                            														<div className="w-[331px] h-[100px] overflow-hidden shrink-0 flex items-center justify-center py-num-10 px-num-16 box-border gap-2.5">
                              															<div className="flex items-center gap-2.5 shrink-0">
                                																<img className="h-[77.2px] w-[81.9px] relative object-cover" alt="" src={DefaultAvatar}/>
                                																<div className="h-num-78 w-[212px] flex flex-col items-center justify-between py-num-8 px-1 box-border gap-0">
                                  																	<b className="self-stretch h-[37.6px] relative tracking-num--0_01 flex items-center shrink-0">AJ De Castro</b>
                                  																	<b className="self-stretch h-[29.7px] relative text-num-14 flex text-dimgray items-center shrink-0">ajdecastro@gmail.com</b>
                                																</div>
                              															</div>
                              															<img className="h-num-70 w-5 relative object-cover shrink-0" alt="" src={dots}/>
                            														</div>
                          													</div>
                        												</div>
                      											</div>
