  ...
  return (
    ...
    >
      <div ref={topRef} className="flex flex-col items-start z-1 shrink-0">
          <div className="self-stretch h-[100dvh] flex flex-col items-start text-num-18 text-darkslategray-200">
          ...
          {/* Hero content */}
          <div className="self-stretch flex-1 flex flex-col items-start justify-center box-border text-center text-[32px] text-gray-800">
