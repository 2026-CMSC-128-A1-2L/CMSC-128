...
const EventPopout: FunctionComponent<EventPopoutType> = ({ className="", onClose }) => {
  	return (
    		<div className={`w-[419px] h-[164px] relative max-w-full max-h-full overflow-auto text-left text-[12px] text-black font-lora ${className}`}>
      		...
      		<img className="absolute top-[11px] left-[367px] w-10 h-10 cursor-pointer" src={exIcon} alt="close" onClick={onClose} />
      		...
      		<img className="absolute top-[44px] left-[53px] w-[24px] h-[24px]" src={dotIcon} alt="red dot" />
