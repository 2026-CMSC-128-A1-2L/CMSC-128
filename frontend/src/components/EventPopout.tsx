...
const EventPopout: FunctionComponent<EventPopoutType> = ({ className="" }) => {
  	return (
    		<div className={`w-[419px] h-[164px] relative max-w-full max-h-full overflow-auto text-left text-[12px] text-black font-lora ${className}`}>
      			<div className="absolute top-[0px] left-[0px] rounded-md bg-white w-[419px] h-[164px]" />
      			<img className="absolute top-[11px] left-[367px] w-10 h-10" alt="" />
      			...
      			<div className="absolute top-[69px] left-[85px] whitespace-pre-wrap">Tuesday, March 9     4:00PM - 5:00PM</div>
      			...
      			<img className="absolute top-[44px] left-[53px] w-[17px] h-[17px]" alt="" />
      			<img className="absolute top-[71px] left-[191px] max-w-full overflow-hidden h-[10.8px]" alt="" />
      			<img className="absolute top-[19px] left-[330px] w-6 h-6" alt="" />
    		</div>);
};
