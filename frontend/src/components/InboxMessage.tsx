      			...
      			<div className="flex-1 flex flex-col items-start gap-[0.125rem]">
        				...
        				<div className="self-stretch flex items-start gap-[0.25rem] text-left text-[0.813rem] text-darkslategray font-inter">
          					...
          					<div className="flex-1 flex flex-col items-start gap-[0.25rem]">
            						<div className="self-stretch flex items-center">
              							<b className="flex-1 relative overflow-hidden text-ellipsis whitespace-nowrap">Verification Status</b>
            						</div>
            						<div className="self-stretch relative text-[0.625rem] tracking-[0.02em] font-semibold font-lora text-dimgray [display:-webkit-inline-box] overflow-hidden text-ellipsis [-webkit-line-clamp:2] [-webkit-box-orient:vertical]">Hi Daphne! Your verification has been approved!<br/></div>
            						</div>
          					</div>
        				</div>
      			</div>);
