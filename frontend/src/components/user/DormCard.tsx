...
const DormCard: FunctionComponent<DormCardProps> = ({
  ...
  return (
    <div
      className={`relative border-whitesmoke border-solid border box-border overflow-hidden flex flex-col items-start text-left text-black font-inter transition-all duration-300 dark:text-white
    ...
    >
      ...
      <div className="w-full flex flex-col py-2 px-3 gap-2">
        ...
        <div className="w-full flex flex-col items-start gap-0">
          ...
          {/* price */}
          <b className="relative text-num-14 text-teal">
              ...
              <div className="w-full h-full flex flex-col item-start">
                <div className="w-full h-full flex flex-col gap-1">
                  {room_types.map((room, index) => (
                    <div
                      key={index}
                      className="flex justify-between text-num-12 font-inter"
                    >
