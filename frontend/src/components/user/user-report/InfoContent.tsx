    ...
    <>
      ...
      <div className="flex flex-1 flex-col md:w-2xl  text-black  font-lora gap-4 py-10">
        ...
        <div className="grid grid-cols-1 w-full gap-y-4 font-semibold ">
          <FAQ
            question="What is the reporting process?"
            answer="Our reporting process is designed to be simple and effective. You can report any issues you encounter through our user-friendly interface."
          />
          <FAQ
            question="How long does it take to resolve a report?"
            answer="We strive to resolve all reports as quickly as possible. The timeline may vary depending on the complexity of the issue."
          />
          <FAQ
            question="Will my identity be disclosed?"
            answer="No, your identity will remain confidential throughout the reporting process."
          />
          <FAQ
            question="Will my report be shared with my landlord or dorm manager?"
            answer="Your report will be shared with your landlord or dorm manager to help them address any concerns. However, rest assured that your identity will remain confidential."
          />
        </div>
      </div>
