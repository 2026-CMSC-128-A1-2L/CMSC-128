...
const JoinedDormitoryPopup: FunctionComponent<JoinedDormitoryPopupType> = ({
  ...
  return (
    <div
      className={`w-[480px] h-[500px] relative rounded-2xl bg-white overflow-hidden flex flex-col items-start p-8 box-border max-w-full max-h-full text-center text-num-24 text-gray-200 font-inter ${className}`}
    >
      <div className="self-stretch h-[436px] overflow-hidden shrink-0 flex flex-col items-center pt-[65px] px-num-10 pb-6 box-border gap-6">
        <div className="self-stretch flex flex-col items-start">
          ...
          <div className="self-stretch overflow-hidden flex flex-col items-center justify-center p-num-10 gap-2.5">
            ...
            <div className="self-stretch relative text-num-14 leading-5 font-medium">
