...
const JoinedDormitoryPopup: FunctionComponent<JoinedDormitoryPopupType> = ({
  className = '',
  onClose,
}) => {
  return (
    <div
      className={`w-[480px] h-[500px] relative rounded-2xl bg-white dark:bg-[#141515] overflow-hidden flex flex-col items-start p-8 box-border max-w-full max-h-full text-center text-num-24 text-gray-200 dark:text-[#d7e0ef] border border-transparent dark:border-[#303331] font-inter ${className}`}
    >
      <div className="self-stretch h-[436px] overflow-hidden shrink-0 flex flex-col items-center pt-[65px] px-num-10 pb-6 box-border gap-6">
        <div className="self-stretch flex flex-col items-start">
          <div className="self-stretch bg-white dark:bg-[#141515] overflow-hidden flex items-center justify-center py-[5px] px-[3px]">
            <div className="flex items-center justify-center w-[100px] h-[100px] rounded-full bg-lightcyan dark:bg-[#12342e]">
        ...
        <div className="self-stretch flex-1 overflow-hidden flex flex-col items-center p-num-10 text-num-14 text-teal-200 dark:text-[#72cbb8]">
          <div
            className="rounded-num-12 bg-lightcyan dark:bg-[#12342e] hover:bg-teal-100 dark:hover:bg-[#1f3a34] overflow-hidden flex items-center justify-center py-3 px-8 cursor-pointer transition-colors"
            onClick={onClose}
          >
