    ...
    <div className="flex flex-col h-full bg-white shadow-xl font-inter overflow-hidden dark:bg-[#101111] dark:text-[#d7e0ef]">
      ...
      <div className="w-full flex items-center justify-between py-6 px-8 border-b border-whitesmoke shrink-0 dark:border-[#303331]">
        ...
        <div className="flex items-center gap-3">
          ...
          <button onClick={onClose} className="flex items-center justify-center p-2 rounded-full hover:bg-whitesmoke transition-colors border-none bg-transparent cursor-pointer dark:hover:bg-[#242526]">
      ...
      <div className="p-8 border-t border-whitesmoke shrink-0 bg-white dark:border-[#303331] dark:bg-[#101111]">
        <button onClick={onClose} className="w-full bg-teal hover:bg-darkgreen text-white font-bold py-4 rounded-[14.1px] transition-all border-none cursor-pointer shadow-md text-num-14 dark:bg-[#12342e] dark:text-[#72cbb8] dark:hover:bg-[#1f3a34] dark:shadow-none">
          Apply Filter
        </button>
      </div>
    </div>
