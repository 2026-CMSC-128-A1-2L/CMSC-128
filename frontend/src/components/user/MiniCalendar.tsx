  ...
  return (
    <div className="h-full w-72 flex flex-col items-start pt-num-0 px-num-0 pb-4 box-border gap-6">
      <div className="rounded-xl bg-white border-whitesmoke-200 border-solid border flex flex-col items-center p-4 isolate">
        ...
        <div className="flex flex-col items-center pt-4 px-num-0 pb-num-0 z-0 text-center text-num-11.59 text-gray font-inter">
          <div className="self-stretch flex items-center justify-center gap-0.5">
            <div className="flex-1 flex items-center justify-center">
              <div className="relative leading-num-19.31 text-xs">Su</div>
            </div>
            <div className="flex-1 flex items-center justify-center">
              <div className="relative leading-num-19.31 text-xs">Mo</div>
            </div>
            <div className="flex-1 flex items-center justify-center">
              <div className="relative leading-num-19.31 text-xs">Tu</div>
            </div>
            <div className="flex-1 flex items-center justify-center">
              <div className="relative leading-num-19.31 text-xs">We</div>
            </div>
            <div className="flex-1 flex items-center justify-center">
              <div className="relative leading-num-19.31 text-xs">Th</div>
            </div>
            <div className="flex-1 flex items-center justify-center">
              <div className="relative leading-num-19.31 text-xs">Fr</div>
            </div>
            <div className="flex-1 flex items-center justify-center">
              <div className="relative leading-num-19.31 text-xs">Sa</div>
            </div>
          </div>
          <div className="flex flex-col items-center isolate gap-0.5 text-num-12 text-black">
            <div className="flex items-center gap-0.5 z-40">
              <div className="h-num-38.6 w-num-38.6 rounded-md flex items-center justify-center p-3 box-border" />
              <div className="h-num-38.6 w-num-38.6 rounded-md flex items-center justify-center p-3 box-border" />
              <div className="h-num-38.6 w-num-38.6 rounded-md flex items-center justify-center p-3 box-border" />
              <div className="h-num-38.6 w-num-38.6 rounded-md flex items-center justify-center p-3 box-border">
              ...
              <div className="h-num-38.6 w-num-38.6 rounded-md bg-lightcyan-100 flex items-center justify-center p-3 box-border text-teal-200 font-inter">
      ...
      <div className="self-stretch overflow-hidden flex flex-col items-start py-2 px-num-0 gap-2 text-center text-num-14">
        ...
        <div className="self-stretch h-auto rounded-2xl border-whitesmoke-200 border-solid border box-border overflow-hidden shrink-0 flex items-center p-4 gap-2 text-num-12 cursor-pointer hover:bg-gray-50" onClick={onEventClick}>
          ...
          <div className="flex flex-col items-start justify-center gap-1 shrink-0">
            ...
            <div className="relative text-num-11.59 tracking-num-0.04 font-medium font-lora text-dimgray">
              April 7, 2026
            </div>
          </div>
        </div>
