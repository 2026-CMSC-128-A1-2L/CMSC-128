...
const UserDocumentCard = ({
  ...
  return (
    <div className="self-stretch flex flex-col items-center justify-center py-num-0 px-num-32 shrink-0 text-left">
      <div className="w-full rounded-num-16 bg-white border-whitesmoke-200 border-solid border box-border overflow-hidden flex flex-col items-start justify-center py-num-10 px-num-32 gap-2.5">
        ...
        <label className="w-full cursor-pointer">
          <div className="w-full rounded-num-16 border-dimgray border-dashed border box-border overflow-hidden flex items-center py-num-12 px-4 text-black hover:bg-whitesmoke-100 transition-colors">
