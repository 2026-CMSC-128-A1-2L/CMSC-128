    ...
    <div className="self-stretch overflow-hidden flex flex-col items-start py-[9.7px] px-num-0 gap-[9.7px] text-center text-[13.52px]">
      ...
      <div className="self-stretch flex flex-col gap-2">
        {events.map((event) => (
          <div
            key={event.id}
            className="self-stretch h-[46.3px] rounded-[15.45px] border-whitesmoke-200 border-solid border box-border overflow-hidden shrink-0 flex items-center p-num-15_4 gap-[9.7px] text-[13.99px] cursor-pointer hover:bg-gray-50 transition-colors"
          ...
          >
            ...
            <div className="flex flex-col items-start justify-center gap-[3.9px] shrink-0">
              ...
              <div className="relative text-num-11.59 tracking-[0.04em] font-medium font-lora text-dimgray">
                {event.date}
              </div>
            </div>
          </div>
