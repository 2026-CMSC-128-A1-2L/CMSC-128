  ...
  return (
    <>
      <p className="flex max-w-4xl text-center font-inter text-[14px] py-5">
        Your experience matters! Help future residents find their perfect home by sharing your
        honest thoughts. This quick three-step process ensures your review provides the most helpful
