...
const DormPickConfirmation: FunctionComponent<Props> = ({ onConfirm, onCancel }) => {
  return (
      ...
      <div className="self-stretch flex flex-col items-center py-8 gap-6">
        <div className="flex flex-col items-center gap-4">
          <div className="bg-white flex items-center justify-center p-2">
            <img className="h-20 w-20" alt="Success Icon" src={success} />
          </div>
          ...
          <div className="flex flex-col items-center gap-2">
            ...
            <p className="text-sm leading-6 font-medium text-dimgray px-4">
              Once you finalize an application, your pending applications will be cleared. Do you
              want to proceed?
            </p>
          </div>
        </div>
...
export default DormPickConfirmation;
