        ...
        <>
            ...
            <div className="flex flex-col max-w-[714px]  text-black  font-lora gap-4 py-10">
                            ...
                            <div className="grid grid-cols-2 gap-x-5 gap-y-4 font-semibold ">
                                <button className="w-full md:w-85 px-6 py-3 text-left  transition-colors bg-whitesmoke-200 cursor-pointer hover:bg-[#e0e0e0]" onClick={()=>{}}>
                        ...
                        <div className="flex gap-10  font-inter font-bold py-10">
                            <button className="px-4 py-1 cursor-pointer text-crimson rounded-full" onClick={()=>{}}>Go Back</button>
                            <button className="px-4 py-1 cursor-pointer text-[#096c5b] bg-[#f1f5f9] rounded-full" onClick={()=>{}}>Proceed</button>
                        </div>
        </>
    )
}
