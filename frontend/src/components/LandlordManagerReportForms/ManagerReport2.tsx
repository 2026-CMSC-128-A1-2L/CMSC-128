...
const ReportManager2: FunctionComponent<Props> = ({
	onNext,
	onCancel,
}) => {
  	return (
          					...
          					<div className="self-stretch flex flex-col items-start pt-8 px-12 pb-5 gap-12 text-num-14 text-dimgray font-inter">
            						...
            						<div className="self-stretch flex flex-col items-start gap-3">
              							<div className="self-stretch flex items-end py-0 pl-0 pr-[22px]">
                								<b className="self-stretch flex-1 relative flex items-center">Financial Misconduct</b>
                								<div className="flex items-center gap-[11px] text-[12px] text-slategray">
                  									<div className="relative font-medium">Select All</div>
                  									<div className="h-6 w-6 relative">
                    										<div className="absolute h-full w-full top-[0%] right-[0%] bottom-[0%] left-[0%] shadow-[0px_0px_2px_rgba(0,_0,_0,_0.25)] rounded bg-whitesmoke" />
                  									</div>
                								</div>
              							</div>
              							<div className="self-stretch flex flex-col items-start text-black">
                								<div className="self-stretch flex flex-col items-start gap-[21px]">
                  									<div className="self-stretch rounded-num-12 flex items-center py-3 pl-num-24 pr-[22px] gap-4">
                    										<div className="flex-1 flex items-center">
                      											<div className="flex flex-col items-start justify-center gap-1">
                        												<b className="relative">Rent Collection Irregularities</b>
                        												<div className="relative text-[12px] font-medium text-dimgray">Delayed deposits, missing payments</div>
                      											</div>
                    										</div>
                  									...
                  									<div className="self-stretch rounded-num-12 flex items-center py-3 pl-num-24 pr-[22px] gap-4">
                    										<div className="flex-1 flex items-center">
                      											<div className="flex flex-col items-start justify-center gap-1">
                        												<b className="relative">Unauthorized Fees or Charges</b>
                        												<div className="relative text-[12px] font-medium text-dimgray">Collects payments not related to tenant’s financial duties</div>
                      											</div>
                    										</div>
                    										<div className="h-6 w-6 relative">
                      											<div className="absolute h-full w-full top-[0%] right-[0%] bottom-[0%] left-[0%] shadow-[0px_0px_2px_rgba(0,_0,_0,_0.25)] rounded bg-whitesmoke" />
                  									...
                  									<div className="self-stretch rounded-num-12 flex items-center py-3 pl-num-24 pr-[22px] gap-4">
                    										<div className="flex-1 flex items-center">
                      											<div className="flex flex-col items-start justify-center gap-1">
                        												<b className="relative">{`Misuse of Funds `}</b>
                        												<div className="relative text-[12px] font-medium text-dimgray">Maintenance funds, deposits, etc.</div>
                      											</div>
                    										</div>
                    										<div className="h-6 w-6 relative">
                      											<div className="absolute h-full w-full top-[0%] right-[0%] bottom-[0%] left-[0%] shadow-[0px_0px_2px_rgba(0,_0,_0,_0.25)] rounded bg-teal" />
