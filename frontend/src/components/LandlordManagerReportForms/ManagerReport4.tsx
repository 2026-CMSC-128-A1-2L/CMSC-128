...
const ReportManager4: FunctionComponent<Props> = ({
	onNext,
	onCancel,
}) => {
  	return (
          					...
          					<div className="self-stretch flex flex-col items-start pt-8 px-12 pb-5 gap-12 text-num-14 text-dimgray font-inter">
            						...
            						<div className="self-stretch flex flex-col items-start gap-4">
              							<div className="self-stretch flex items-end py-0 pl-0 pr-num-22">
                								...
                								<div className="flex items-center gap-[11px] text-num-12 text-slategray">
              							...
              							<div className="self-stretch flex flex-col items-start text-black">
                								<div className="self-stretch flex flex-col items-start gap-2">
                  									<div className="self-stretch rounded-num-12 flex items-center py-3 pl-num-24 pr-num-22 gap-4">
                    										<div className="flex-1 flex items-center">
                      											<div className="flex flex-col items-start justify-center gap-1">
                        												<b className="relative shrink-0">Allowing Unauthorized Access</b>
                        												<div className="relative text-num-12 font-medium text-dimgray hidden shrink-0">Delayed deposits, missing payments</div>
                      											</div>
                    										</div>
                  									...
                  									<div className="self-stretch rounded-num-12 flex items-center py-3 pl-num-24 pr-num-22 gap-4">
                    										<div className="flex-1 flex items-center">
                      											<div className="flex flex-col items-start justify-center gap-1">
                        												<b className="relative shrink-0">Negligent Security Practices</b>
                        												<div className="relative text-num-12 font-medium text-dimgray hidden shrink-0">Collects payments not related to tenant’s financial duties</div>
                      											</div>
                    										</div>
                    										<div className="h-6 w-6 relative">
                      											<div className="absolute h-full w-full top-[0%] right-[0%] bottom-[0%] left-[0%] shadow-[0px_0px_2px_rgba(0,_0,_0,_0.25)] rounded-num-4 bg-whitesmoke" />
                  									...
                  									<div className="self-stretch rounded-num-12 flex items-center py-3 pl-num-24 pr-num-22 gap-4">
                    										<div className="flex-1 flex items-center">
                      											<div className="flex flex-col items-start justify-center gap-1">
                        												<b className="relative shrink-0">Failure to Report Incidents</b>
                        												<div className="relative text-num-12 font-medium text-dimgray hidden shrink-0">Maintenance funds, deposits, etc.</div>
                      											</div>
                    										</div>
                    										<div className="h-6 w-6 relative">
                      											<div className="absolute h-full w-full top-[0%] right-[0%] bottom-[0%] left-[0%] shadow-[0px_0px_2px_rgba(0,_0,_0,_0.25)] rounded-num-4 bg-whitesmoke" />
                  									...
                  									<div className="self-stretch rounded-num-12 flex items-center py-3 pl-num-24 pr-num-22 gap-4">
                    										<div className="flex-1 flex items-center">
                      											<div className="flex flex-col items-start justify-center gap-1">
                        												<b className="relative shrink-0">Tampering with Surveillance Systems</b>
                        												<div className="relative text-num-12 font-medium text-dimgray hidden shrink-0">Maintenance funds, deposits, etc.</div>
                      											</div>
                    										</div>
                    										<div className="h-6 w-6 relative">
