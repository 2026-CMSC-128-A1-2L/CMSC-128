...
const ReportManager1: FunctionComponent<Props> = ({ onNext, onCancel, className = '' }) => {
  return (
    /* Main container scaled to 80% width */
    <div
      className={`relative rounded-tl-[25.6px] rounded-tr-0 rounded-b-0 bg-white w-full flex items-center text-left text-[32px] text-white font-poppins ${className}`}
    >
          ...
          <div className="self-stretch flex flex-col items-start pt-[25.6px] px-[38.4px] pb-[16px] gap-[38.4px] text-num-14 text-dimgray font-inter">
            <div className="self-stretch flex flex-col items-start gap-[9.6px]">
              ...
              <div className="self-stretch flex items-center justify-center py-0 px-[6.4px] text-num-18 text-black">
                <b className="flex-1 relative tracking-[-0.008em]">
              ...
              <div className="self-stretch flex flex-col items-start text-black">
                <div className="self-stretch flex flex-col items-start gap-[16.8px]">
                  ...
                  {[
                    ...
                    <div
                      key={index}
                      className="self-stretch rounded-[9.6px] flex items-center py-[9.6px] pl-[19.2px] pr-[17.6px] gap-[12.8px]"
                    >
                      ...
                      <div className="h-[19.2px] w-[19.2px] relative shrink-0">
                        <div
                          className={`absolute h-full w-full rounded-[3.2px] shadow-[0px_0px_1.6px_rgba(0,_0,_0,_0.25)] ${item.checked ? 'bg-teal' : 'bg-whitesmoke-200'}`}
                        />
                        {item.checked && (
                          <img
