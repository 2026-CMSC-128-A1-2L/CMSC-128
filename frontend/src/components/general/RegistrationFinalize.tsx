    ...
    <div className="flex-1 w-full relative overflow-hidden flex items-start justify-center text-center text-num-14 text-dimgray font-inter">
      <div className="w-[620px] rounded-num-12 border-whitesmoke dark:border-[#303331] bg-white dark:bg-[#141515] border-solid border box-border overflow-hidden flex flex-col items-start pt-3 px-4 pb-4 gap-4">
        ...
        <div className="self-stretch flex flex-col items-start gap-3 px-num-10">
          {/* Full Name */}
          <div className="self-stretch h-11 rounded-num-12 bg-aliceblue dark:bg-[#1f2022] border-whitesmoke dark:border-[#303331] border-solid border box-border overflow-hidden flex items-center py-0 px-3 gap-2.5">
            <div className="overflow-hidden flex items-center p-1 shrink-0">
              <Icon
                icon="material-symbols:person-outline-rounded"
                className="h-6 w-6 text-dimgray dark:text-[#a4acba]"
              />
            </div>
            <div className="flex items-center gap-4 flex-1">
              <span className="text-sm font-medium text-black dark:text-[#d7e0ef] flex-1 text-left leading-6">
                {data.firstName || '—'}
              </span>
              <div className="self-stretch w-0.5 rounded-[100px] bg-whitesmoke dark:bg-[#303331] shrink-0" />
              <span className="text-sm font-medium text-black dark:text-[#d7e0ef] flex-1 text-center leading-6">
                {data.middleName || '—'}
              </span>
              <div className="self-stretch w-0.5 rounded-[100px] bg-whitesmoke dark:bg-[#303331] shrink-0" />
              <span className="text-sm font-medium text-black dark:text-[#d7e0ef] flex-1 text-right leading-6">
                {data.lastName || '—'}
              </span>
            </div>
          </div>
