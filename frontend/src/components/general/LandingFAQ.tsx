...
const LandingFAQ: FunctionComponent = () => {
  ...
  return (
    ...
    >
      ...
      <div className="w-[1280px] relative text-num-18 text-gray-300 font-lora">
          ...
          {TABS.map(tab => {
            ...
            return (
              <button
                ...
                className={`flex-1 flex flex-col items-center justify-center gap-1 py-4 cursor-pointer transition-colors duration-200 text-num-14 font-poppins font-bold ${
                  isActive
          ...
          {FAQ_DATA[activeTab].map((item, i) => {
            ...
            return (
              ...
              >
                ...
                >
                  <b className="flex-1 text-num-18 text-gray-300 font-lora">{item.q}</b>
                  <Icon
