...
const InboxMessage: FunctionComponent<InboxMessageProps> = ({
    ...
    return (
        <div
            className={`w-full relative rounded-xl border-solid border box-border flex items-start pt-2 px-3 pb-4 gap-2 text-right text-[0.5rem] font-lora cursor-pointer transition-colors ${active
