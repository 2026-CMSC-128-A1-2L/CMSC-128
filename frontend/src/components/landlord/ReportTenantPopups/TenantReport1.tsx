    ...
    <div className="relative rounded-tl-[32px] rounded-tr-num-0 rounded-b-num-0 bg-white w-full flex items-center text-left text-[32px] text-white font-poppins">
      <div className="w-[612px] flex flex-col items-center justify-center pt-num-0 px-num-0 pb-8 box-border gap-[42px]">
        <div className="self-stretch flex flex-col items-center">
          <div className="self-stretch rounded-tl-[32px] rounded-tr-num-0 rounded-b-num-0 [background:linear-gradient(183.48deg,#096c5b,#16917c)] flex flex-col items-start justify-center py-num-12 pl-[57px] pr-8">
              ...
              <div className="self-stretch flex items-end py-num-0 pl-num-0 pr-num-22">
                ...
                >
                  ...
                  <div className="h-6 w-6 relative">
                    <div
                      className={`absolute h-full w-full top-[0%] right-[0%] bottom-[0%] left-[0%] shadow-[0px_0px_2px_rgba(0,0,0,0.25)] rounded-num-4 ${
                        selectedViolations.length === VIOLATIONS.length
                          ? 'bg-teal'
                          : 'bg-whitesmoke-100'
                      }`}
                  ...
                  {VIOLATIONS.map((violation) => (
                    ...
                    >
                      ...
                      <div className="h-6 w-6 relative overflow-hidden shrink-0">
                        <div
                          className={`absolute h-full w-full top-[0%] right-[0%] bottom-[0%] left-[0%] shadow-[0px_0px_2px_rgba(0,0,0,0.25)] rounded-num-4 transition-all ${
