...
const FINANCIAL_VIOLATIONS: FinancialViolation[] = [
  {
    id: 'failure-to-pay',
    label: 'Failure to Pay Rent Fees',
    description: 'Consistent failure to pay rent on specified time.',
  },
  {
    id: 'late-payments',
    label: 'Persistent Late Payments',
    description: 'Frequent late payment of fees.',
  },
  {
    id: 'unpaid-utilities',
    label: 'Unpaid Utilities',
    description: 'Failure to pay assigned utility bills.',
  },
];

const ReportTenant2: FunctionComponent = () => {
