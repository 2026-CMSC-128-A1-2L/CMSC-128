          ...
          <div className="w-[880px] rounded-2xl bg-white border-whitesmoke border-solid border-[1px] box-border flex flex-col items-start py-8 px-12 gap-3">
            ...
            <div className="self-stretch flex flex-col items-start py-4 px-0 gap-4">
              ...
              <div className="self-stretch grid grid-cols-2 gap-4">
                ...
                {/* Allow Pasalo */}
                <div className={`rounded-2xl border flex items-center py-4 px-5 gap-4 ${buildingInfo.allowPasalo ? 'bg-teal-50 border-teal-200' : 'bg-aliceblue border-whitesmoke'
                  }`}>
                  <div className={`w-8 h-8 rounded-full flex items-center justify-center shrink-0 ${buildingInfo.allowPasalo ? 'bg-teal-100' : 'bg-gray-100'
                    }`}>
                    <Icon
                  ...
                  <div className="flex flex-col gap-0.5 flex-1">
                    ...
                    <span className="text-xs font-medium text-slategray">Lease transfer allowed</span>
                  </div>
                  <span className={`text-xs font-semibold rounded-full px-3 py-1 shrink-0 ${buildingInfo.allowPasalo ? 'bg-teal-100 text-teal-700' : 'bg-gray-100 text-gray-400'
                    }`}>
                ...
                {/* Allow Ocular Visit */}
                <div className={`rounded-2xl border flex items-center py-4 px-5 gap-4 ${buildingInfo.allowOcularVisit ? 'bg-teal-50 border-teal-200' : 'bg-aliceblue border-whitesmoke'
                  }`}>
                  <div className={`w-8 h-8 rounded-full flex items-center justify-center shrink-0 ${buildingInfo.allowOcularVisit ? 'bg-teal-100' : 'bg-gray-100'
                    }`}>
                    <Icon
                  ...
                  <div className="flex flex-col gap-0.5 flex-1">
                    ...
                    <span className="text-xs font-medium text-slategray">In-person visits allowed</span>
                  </div>
                  <span className={`text-xs font-semibold rounded-full px-3 py-1 shrink-0 ${buildingInfo.allowOcularVisit ? 'bg-teal-100 text-teal-700' : 'bg-gray-100 text-gray-400'
                    }`}>
