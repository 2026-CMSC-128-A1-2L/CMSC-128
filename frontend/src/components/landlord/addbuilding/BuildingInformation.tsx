        ...
        <div className="w-[880px] flex flex-col items-start">
          <div className="w-[880px] rounded-2xl bg-white border-whitesmoke border-solid border-[1px] box-border flex flex-col items-start py-8 px-12 gap-3 dark:bg-[#101111] dark:border-[#343737]">
                    ...
                    <div className="self-stretch flex flex-col gap-1">
                      <div className="self-stretch rounded-num-12 bg-aliceblue border-whitesmoke border-solid border-[1px] flex items-center py-3 px-num-16 dark:bg-[#1f2022] dark:border-[#3a3d3c]">
                        <input
                          ...
                          placeholder="Aa"
                          className="flex-1 bg-transparent text-sm text-gray-700 placeholder-slategray outline-none font-medium leading-num-24 dark:text-[#d7e0ef] dark:placeholder-[#8c95a3]"
                        />
                      </div>
                      {errors.name && (
                    ...
                    <div className="self-stretch flex flex-col gap-1">
                      <div className="self-stretch h-12 rounded-num-12 bg-aliceblue border-whitesmoke border-solid border-[1px] box-border flex items-center px-4 dark:bg-[#1f2022] dark:border-[#3a3d3c]">
                        <select
                          ...
                          className="flex-1 bg-transparent text-sm text-gray-700 outline-none font-medium appearance-none cursor-pointer dark:text-[#d7e0ef]"
                        >
            ...
            <div className="self-stretch overflow-hidden flex flex-col items-start p-num-10 gap-2.5">
              ...
              <div className="self-stretch flex flex-col gap-3 text-left text-num-14 text-gray">
                ...
                <button
                  type="button"
                  onClick={addRoomType}
                  className="w-full h-[100px] rounded-xl border border-whitesmoke overflow-hidden flex items-center justify-center hover:bg-gray-50 transition-colors dark:border-[#343737] dark:hover:bg-[#1f2022]"
                >
                  <Icon icon="material-symbols:add-rounded" className="w-8 h-8 text-[#096C5B] dark:text-[#72cbb8]" />
                </button>
              </div>
            </div>
            {/* ── Cashless Payments ── */}
            ...
            <div className="self-stretch overflow-hidden flex flex-col items-start p-num-10 gap-3">
              <div className="self-stretch flex items-center">
                <b className="relative tracking-num--0_01 text-teal-900 dark:text-[#72cbb8]">Building Policies</b>
              </div>
              <div className="self-stretch flex flex-col gap-2.5">
                {/* Allow Pasalo */}
                <div
                  onClick={() =>
                    setBuildingInfo({ ...buildingInfo, allowPasalo: !buildingInfo.allowPasalo })
                  }
                ...
                >
                  ...
                  <div
                    className={`w-11 h-11 rounded-xl flex items-center justify-center shrink-0 transition-colors ${
                      buildingInfo.allowPasalo ? 'bg-[#34655d]' : 'bg-[#f0f2f5] dark:bg-[#1f2022]'
                    }`}
                  >
                    <Icon
                ...
                >
                  ...
                  <div
                    className={`w-11 h-11 rounded-xl flex items-center justify-center shrink-0 transition-colors ${
                      buildingInfo.allowOcularVisit ? 'bg-[#34655d]' : 'bg-[#f0f2f5] dark:bg-[#1f2022]'
                    }`}
                  >
                    <Icon
                  ...
                  <div
                    className={`h-[26px] w-[48px] relative rounded-full shrink-0 transition-colors ${
                      buildingInfo.allowOcularVisit ? 'bg-[#42a391]' : 'bg-gray-800'
                    }`}
                  >
                    <div
                      className={`absolute top-[3px] h-5 w-5 rounded-full bg-white shadow-sm transition-all duration-200 ${
                        buildingInfo.allowOcularVisit ? 'left-[25px]' : 'left-[3px]'
                      }`}
                    />
                  </div>
                </div>
