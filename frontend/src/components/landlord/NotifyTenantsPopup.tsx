...
const NotifyTenantsPopup: FunctionComponent<Props> = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative flex w-[480px] flex-col items-center overflow-hidden rounded-[26px] bg-white max-h-[90vh] dark:bg-[#141515] dark:border dark:border-[#303331]">
        {/* Header */}
        ...
        <div className="flex w-full flex-col items-center overflow-y-auto flex-1 px-[46px] pt-[32px]">
          ...
          <div className="flex w-full flex-col items-center gap-[10px] pt-[24px] pb-[8px] text-center">
            <h2 className="font-['Inter',sans-serif] text-[20px] font-bold text-[#001d18] dark:text-[#edf6f4]">
              Tenants Notified
            </h2>
