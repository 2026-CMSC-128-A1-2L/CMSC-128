      ...
      >
        ...
        <div className="flex flex-1 w-full flex-col justify-end gap-[12px]">
          ...
          >
            ...
            >
              <Icon icon="gg:dark-mode" className="h-[24px] w-[24px] shrink-0 text-[#001d18]" aria-hidden="true" />
              {!collapsed && (
                ...
                <span className="flex flex-col items-start justify-center gap-[4px] overflow-hidden">
                  ...
                  {user.verified && (
                    <span className="flex items-center gap-[4px]">
                      ...
                      <Icon icon="material-symbols:verified" className="h-[10px] w-[10px] text-[#0c8873]" aria-hidden="true" />
                    </span>
                  )}
                </span>
              )}
