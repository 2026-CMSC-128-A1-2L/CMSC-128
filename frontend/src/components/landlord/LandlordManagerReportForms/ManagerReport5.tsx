      ...
      <div className="self-stretch px-[38.4px] pb-[16px]">
        ...
        >
          ...
          <p className="flex-1 font-['Inter',sans-serif] text-[14px] leading-[25px] text-black">
            ...
            <span className="font-medium">
              {' '}
              to the best of my knowledge. I acknowledge that any false or misleading information
              may lead to consequences in accordance with applicable rules and regulations.
            </span>
          </p>
        </button>
      </div>
