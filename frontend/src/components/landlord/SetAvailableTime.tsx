...
const SetAvailableTime: FunctionComponent<SetAvailableTimeType> = ({ className="", onClose }) => {
  	return (
    		<div className={`relative rounded-2xl bg-white overflow-hidden flex flex-col items-start py-num-32 px-12 box-border gap-2.5 max-w-full max-h-full text-center text-num-24 text-teal font-inter ${className}`}>
      			...
      			<div className="flex items-start gap-2.5 text-num-12 text-black">
        				...
        				<div className="flex flex-col items-center justify-center gap-4 text-left text-num-14 text-dimgray">
          					...
          					<div className="w-full flex-1 bg-white overflow-hidden shrink-0 grid box-border grid-cols-[repeat(7,_1fr)] grid-rows-[repeat(10,_1fr)] gap-1">
