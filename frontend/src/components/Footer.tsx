...
const Footer: FunctionComponent = () => {
  return (
    <div className="w-full h-20 relative bg-white overflow-hidden shrink-0 flex flex-col items-center justify-center text-center text-num-14 text-dimgray font-inter">
      <div className="w-full bg-whitesmoke overflow-hidden flex items-center py-[19px] pl-[200px] pr-20 box-border max-w-full">
