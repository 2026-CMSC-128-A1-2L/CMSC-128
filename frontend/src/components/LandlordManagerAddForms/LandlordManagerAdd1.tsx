      			...
      			<div className="w-[612px] flex flex-col items-center justify-center pt-0 px-0 pb-[60px] box-border gap-[42px]">
        				<div className="self-stretch h-[873px] flex flex-col items-center">
          					<div className="self-stretch rounded-tl-[32px] rounded-tr-num-0 rounded-b-num-0 [background:linear-gradient(183.48deg,_#096c5b,_#16917c)] flex flex-col items-start justify-center py-3 pl-[57px] pr-8 shrink-0">
            						<div className="w-[533px] flex flex-col items-start justify-center pt-8 px-0 pb-2 box-border shrink-0">
              							...
              							<b className="self-stretch relative text-[18px] tracking-[-0.01em] font-inter text-aliceblue">Set permission for the facility manager</b>
            						</div>
          					</div>
                								...
                								<div className="self-stretch rounded-num-12 flex items-center py-3 pl-3 pr-num-22 gap-4">
                  									<div className="flex-1 flex items-center gap-4">
                    										...
                    										<div className="flex flex-col items-start justify-center gap-1">
                      											...
                      											<div className="relative text-[12px] font-medium text-dimgray">Allow manager to remove building records</div>
                    										</div>
                  									</div>
                  									<div className="h-6 w-6 relative">
                    										<div className="absolute h-full w-full top-[0%] right-[0%] bottom-[0%] left-[0%] shadow-[0px_0px_2px_rgba(0,_0,_0,_0.25)] rounded-num-4 bg-whitesmoke" />
                								...
                								<div className="self-stretch rounded-num-12 flex items-center py-3 pl-3 pr-num-22 gap-4">
                  									<div className="flex-1 flex items-center gap-4">
                    										...
                    										<div className="flex flex-col items-start justify-center gap-1">
                      											...
                      											<div className="relative text-[12px] font-medium text-dimgray">Allow manager to remove listing records</div>
                    										</div>
                  									</div>
                  									<div className="h-6 w-6 relative">
                    										<div className="absolute h-full w-full top-[0%] right-[0%] bottom-[0%] left-[0%] shadow-[0px_0px_2px_rgba(0,_0,_0,_0.25)] rounded-num-4 bg-whitesmoke" />
                								...
                								<div className="self-stretch rounded-num-12 flex items-center py-3 pl-3 pr-num-22 gap-4">
                  									<div className="flex-1 flex items-center gap-4">
                    										...
                    										<div className="flex flex-col items-start justify-center gap-1">
                      											...
                      											<div className="relative text-[12px] font-medium text-dimgray">Allow manager to access and edit building info</div>
                    										</div>
                  									</div>
                  									<div className="h-6 w-6 relative">
                    										<div className="absolute h-full w-full top-[0%] right-[0%] bottom-[0%] left-[0%] shadow-[0px_0px_2px_rgba(0,_0,_0,_0.25)] rounded-num-4 bg-whitesmoke" />
                								...
                								<div className="self-stretch rounded-num-12 flex items-center py-3 pl-3 pr-num-22 gap-4">
                  									<div className="flex-1 flex items-center gap-4">
                    										...
                    										<div className="flex flex-col items-start justify-center gap-1">
                      											...
                      											<div className="relative text-[12px] font-medium text-dimgray">Manage rents and utility payments</div>
                    										</div>
                  									</div>
                  									<div className="h-6 w-6 relative">
                    										<div className="absolute h-full w-full top-[0%] right-[0%] bottom-[0%] left-[0%] shadow-[0px_0px_2px_rgba(0,_0,_0,_0.25)] rounded-num-4 bg-whitesmoke" />
                								...
                								<div className="self-stretch rounded-num-12 flex items-center py-3 pl-3 pr-num-22 gap-4">
                  									<div className="flex-1 flex items-center gap-4">
                    										...
                    										<div className="flex flex-col items-start justify-center gap-1">
                      											...
                      											<div className="relative text-[12px] font-medium text-dimgray">Accept ocular visit requests from potential tenants</div>
                    										</div>
                  									</div>
                  									<div className="h-6 w-6 relative">
                    										<div className="absolute h-full w-full top-[0%] right-[0%] bottom-[0%] left-[0%] shadow-[0px_0px_2px_rgba(0,_0,_0,_0.25)] rounded-num-4 bg-whitesmoke" />
                								...
                								<div className="self-stretch rounded-num-12 flex items-center py-3 pl-3 pr-num-22 gap-4">
                  									<div className="flex-1 flex items-center gap-4">
                    										...
                    										<div className="flex flex-col items-start justify-center gap-1">
                      											...
                      											<div className="relative text-[12px] font-medium text-dimgray">Report users for misconduct upon review</div>
                    										</div>
                  									</div>
                  									<div className="h-6 w-6 relative">
                    										<div className="absolute h-full w-full top-[0%] right-[0%] bottom-[0%] left-[0%] shadow-[0px_0px_2px_rgba(0,_0,_0,_0.25)] rounded-num-4 bg-whitesmoke" />
        				...
        				<div className="flex items-center gap-4 text-num-14 text-crimson font-inter">
          					...
          					<div className="rounded-num-12 bg-lightcyan overflow-hidden flex items-center justify-center py-2 px-6 text-teal">
            						<button className="relative font-semibold inline-block max-w-[269.11px]" onClick={onSend}>Send Invite</button>
          					</div>
        				</div>
      			</div>
    		</div>);
