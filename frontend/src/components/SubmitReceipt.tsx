...
const SubmitReceipt: FunctionComponent<SubmitReceiptType> = ({ className="" }) => {
  	return (
    		<div className={`w-[480px] h-[480px] relative rounded-num-16 bg-white overflow-hidden flex flex-col items-start p-num-32 box-border max-w-full max-h-full text-left text-num-24 text-black font-inter ${className}`}>
